...
$dataPublicacao = Funcoes::DataGravacaoSql($_POST["data_publicacao"], $GLOBALS['configSiteFormatoData']);
if($dataPublicacao == "")
{
...
$data6 = Funcoes::DataGravacaoSql($_POST["data6"], $GLOBALS['configSiteFormatoData']);
if($data6 == "")
{
	$data6 = NULL;	
}
$data7 = Funcoes::DataGravacaoSql($_POST["data7"], $GLOBALS['configSiteFormatoData']);
if($data7 == "")
{
	$data7 = NULL;	
}
$data8 = Funcoes::DataGravacaoSql($_POST["data8"], $GLOBALS['configSiteFormatoData']);
if($data8 == "")
{
	$data8 = NULL;	
}
$data9 = Funcoes::DataGravacaoSql($_POST["data9"], $GLOBALS['configSiteFormatoData']);
if($data9 == "")
{
	$data9 = NULL;	
}
$data10 = Funcoes::DataGravacaoSql($_POST["data10"], $GLOBALS['configSiteFormatoData']);
if($data10 == "")
{
	$data10 = NULL;	
}
...
//Montagem do query.
//----------
$strSqlVeiculosInsert = "";
$strSqlVeiculosInsert .= "INSERT INTO tb_veiculos ";
$strSqlVeiculosInsert .= "SET ";
$strSqlVeiculosInsert .= "id = :id, ";
$strSqlVeiculosInsert .= "id_tb_categorias = :id_tb_categorias, ";
$strSqlVeiculosInsert .= "id_tb_cadastro_usuario = :id_tb_cadastro_usuario, ";
$strSqlVeiculosInsert .= "modalidade = :modalidade, ";
$strSqlVeiculosInsert .= "data_publicacao = :data_publicacao, ";

$strSqlVeiculosInsert .= "data1 = :data1, ";
$strSqlVeiculosInsert .= "data2 = :data2, ";
$strSqlVeiculosInsert .= "data3 = :data3, ";
$strSqlVeiculosInsert .= "data4 = :data4, ";
$strSqlVeiculosInsert .= "data5 = :data5, ";
$strSqlVeiculosInsert .= "data6 = :data6, ";
$strSqlVeiculosInsert .= "data7 = :data7, ";
$strSqlVeiculosInsert .= "data8 = :data8, ";
$strSqlVeiculosInsert .= "data9 = :data9, ";
$strSqlVeiculosInsert .= "data10 = :data10, ";

$strSqlVeiculosInsert .= "codigo = :codigo, ";
$strSqlVeiculosInsert .= "n_classificacao = :n_classificacao, ";
$strSqlVeiculosInsert .= "veiculo = :veiculo, ";
$strSqlVeiculosInsert .= "descricao = :descricao, ";

$strSqlVeiculosInsert .= "portas = :portas, ";
$strSqlVeiculosInsert .= "kilometragem = :kilometragem, ";
$strSqlVeiculosInsert .= "placa = :placa, ";
$strSqlVeiculosInsert .= "ano_fabricacao = :ano_fabricacao, ";
$strSqlVeiculosInsert .= "ano_modelo = :ano_modelo, ";

$strSqlVeiculosInsert .= "id_tb_cadastro1 = :id_tb_cadastro1, ";
$strSqlVeiculosInsert .= "id_tb_cadastro2 = :id_tb_cadastro2, ";
$strSqlVeiculosInsert .= "id_tb_cadastro3 = :id_tb_cadastro3, ";
$strSqlVeiculosInsert .= "id_tb_cadastro4 = :id_tb_cadastro4, ";
$strSqlVeiculosInsert .= "id_tb_cadastro5 = :id_tb_cadastro5, ";

$strSqlVeiculosInsert .= "informacao_complementar1 = :informacao_complementar1, ";
$strSqlVeiculosInsert .= "informacao_complementar2 = :informacao_complementar2, ";
$strSqlVeiculosInsert .= "informacao_complementar3 = :informacao_complementar3, ";
$strSqlVeiculosInsert .= "informacao_complementar4 = :informacao_complementar4, ";
$strSqlVeiculosInsert .= "informacao_complementar5 = :informacao_complementar5, ";
$strSqlVeiculosInsert .= "informacao_complementar6 = :informacao_complementar6, ";
$strSqlVeiculosInsert .= "informacao_complementar7 = :informacao_complementar7, ";
$strSqlVeiculosInsert .= "informacao_complementar8 = :informacao_complementar8, ";
$strSqlVeiculosInsert .= "informacao_complementar9 = :informacao_complementar9, ";
$strSqlVeiculosInsert .= "informacao_complementar10 = :informacao_complementar10, ";
$strSqlVeiculosInsert .= "informacao_complementar11 = :informacao_complementar11, ";
$strSqlVeiculosInsert .= "informacao_complementar12 = :informacao_complementar12, ";
$strSqlVeiculosInsert .= "informacao_complementar13 = :informacao_complementar13, ";
$strSqlVeiculosInsert .= "informacao_complementar14 = :informacao_complementar14, ";
$strSqlVeiculosInsert .= "informacao_complementar15 = :informacao_complementar15, ";
$strSqlVeiculosInsert .= "informacao_complementar16 = :informacao_complementar16, ";
$strSqlVeiculosInsert .= "informacao_complementar17 = :informacao_complementar17, ";
$strSqlVeiculosInsert .= "informacao_complementar18 = :informacao_complementar18, ";
$strSqlVeiculosInsert .= "informacao_complementar19 = :informacao_complementar19, ";
$strSqlVeiculosInsert .= "informacao_complementar20 = :informacao_complementar20, ";
$strSqlVeiculosInsert .= "informacao_complementar21 = :informacao_complementar21, ";
$strSqlVeiculosInsert .= "informacao_complementar22 = :informacao_complementar22, ";
$strSqlVeiculosInsert .= "informacao_complementar23 = :informacao_complementar23, ";
$strSqlVeiculosInsert .= "informacao_complementar24 = :informacao_complementar24, ";
$strSqlVeiculosInsert .= "informacao_complementar25 = :informacao_complementar25, ";
$strSqlVeiculosInsert .= "informacao_complementar26 = :informacao_complementar26, ";
$strSqlVeiculosInsert .= "informacao_complementar27 = :informacao_complementar27, ";
$strSqlVeiculosInsert .= "informacao_complementar28 = :informacao_complementar28, ";
$strSqlVeiculosInsert .= "informacao_complementar29 = :informacao_complementar29, ";
$strSqlVeiculosInsert .= "informacao_complementar30 = :informacao_complementar30, ";
$strSqlVeiculosInsert .= "informacao_complementar31 = :informacao_complementar31, ";
$strSqlVeiculosInsert .= "informacao_complementar32 = :informacao_complementar32, ";
$strSqlVeiculosInsert .= "informacao_complementar33 = :informacao_complementar33, ";
$strSqlVeiculosInsert .= "informacao_complementar34 = :informacao_complementar34, ";
$strSqlVeiculosInsert .= "informacao_complementar35 = :informacao_complementar35, ";

$strSqlVeiculosInsert .= "informacao_complementar36 = :informacao_complementar36, ";
$strSqlVeiculosInsert .= "informacao_complementar37 = :informacao_complementar37, ";
$strSqlVeiculosInsert .= "informacao_complementar38 = :informacao_complementar38, ";
$strSqlVeiculosInsert .= "informacao_complementar39 = :informacao_complementar39, ";
$strSqlVeiculosInsert .= "informacao_complementar40 = :informacao_complementar30, ";

$strSqlVeiculosInsert .= "id_db_cep_tblBairros = :id_db_cep_tblBairros, ";
$strSqlVeiculosInsert .= "id_db_cep_tblCidades = :id_db_cep_tblCidades, ";
$strSqlVeiculosInsert .= "id_db_cep_tblLogradouros = :id_db_cep_tblLogradouros, ";
$strSqlVeiculosInsert .= "id_db_cep_tblUF = :id_db_cep_tblUF, ";

$strSqlVeiculosInsert .= "veiculo_endereco = :veiculo_endereco, ";
$strSqlVeiculosInsert .= "veiculo_endereco_numero = :veiculo_endereco_numero, ";
$strSqlVeiculosInsert .= "veiculo_endereco_complemento = :veiculo_endereco_complemento, ";
$strSqlVeiculosInsert .= "veiculo_bairro = :veiculo_bairro, ";
$strSqlVeiculosInsert .= "veiculo_cidade = :veiculo_cidade, ";
$strSqlVeiculosInsert .= "veiculo_estado = :veiculo_estado, ";
$strSqlVeiculosInsert .= "veiculo_pais = :veiculo_pais, ";
$strSqlVeiculosInsert .= "veiculo_cep = :veiculo_cep, ";

$strSqlVeiculosInsert .= "contato = :contato, ";
$strSqlVeiculosInsert .= "email = :email, ";

$strSqlVeiculosInsert .= "link_externo = :link_externo, ";
$strSqlVeiculosInsert .= "url1 = :url1, ";
$strSqlVeiculosInsert .= "url2 = :url2, ";
$strSqlVeiculosInsert .= "url3 = :url3, ";
$strSqlVeiculosInsert .= "url4 = :url4, ";
$strSqlVeiculosInsert .= "url5 = :url5, ";

//$strSqlVeiculosInsert .= "url_amigavel = :url_amigavel, ";
$strSqlVeiculosInsert .= "palavras_chave = :palavras_chave, ";

$strSqlVeiculosInsert .= "valor = :valor, ";
$strSqlVeiculosInsert .= "valor1 = :valor1, ";
$strSqlVeiculosInsert .= "valor2 = :valor2, ";

$strSqlVeiculosInsert .= "ativacao = :ativacao, ";
$strSqlVeiculosInsert .= "ativacao1 = :ativacao1, ";
$strSqlVeiculosInsert .= "ativacao2 = :ativacao2, ";
$strSqlVeiculosInsert .= "ativacao3 = :ativacao3, ";
$strSqlVeiculosInsert .= "ativacao4 = :ativacao4, ";
$strSqlVeiculosInsert .= "ativacao_promocao = :ativacao_promocao, ";
$strSqlVeiculosInsert .= "ativacao_home = :ativacao_home, ";
$strSqlVeiculosInsert .= "ativacao_home_categoria = :ativacao_home_categoria, ";
$strSqlVeiculosInsert .= "ativacao_info_cadastro = :ativacao_info_cadastro, ";
$strSqlVeiculosInsert .= "acesso_restrito = :acesso_restrito, ";
$strSqlVeiculosInsert .= "id_tb_veiculos_status = :id_tb_veiculos_status, ";
//$strSqlVeiculosInsert .= "imagem = :imagem, ";
$strSqlVeiculosInsert .= "anotacoes_internas = :anotacoes_internas, ";
$strSqlVeiculosInsert .= "n_visitas = :n_visitas ";
//----------


//Parametros e execução.
//----------
$statementVeiculosInsert = $dbSistemaConPDO->prepare($strSqlVeiculosInsert);

//"url_amigavel" => $url_amigavel,
if ($statementVeiculosInsert !== false)
{
	$statementVeiculosInsert->execute(array(
		"id" => $id,
...
//Limpeza de objetos.
//----------
unset($strSqlVeiculosInsert);
unset($statementVeiculosInsert);
//----------
