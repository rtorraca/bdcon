                                ...
                                <?php if($flagManutencaoLink == true){ ?>
                                    ...
                                    <?php if($configManutencaoLink == 3){ ?>
                                        <a onclick="iframeLoad('iframeManutencaoAjax', 'SiteAdmHistoricoManutencao.php?tipoComplemento=15&masterPageSiteSelect=LayoutSiteIFrame.php&idItem=<?php echo $idTbHistorico;?>&configCaixaSelecao=<?php echo $GLOBALS['configHistoricoFiltroGenerico04CaixaSelecao'];?>', '', '', '');
                                                 ...
                                                 <?php //echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSite'], "siteItemFiltroGenerico04"); ?>
                                            	<img id="imgManutencao04" alt="<?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSite'], "siteItemFiltroGenerico04"); ?>"/>
                                            </a>
                                        <?php } ?>                                
                                    <?php } ?>                                
                                </div>
                        ...
                        <div style="position: absolute; display: block; top: 120px; left: 205px;">
                            ...
                            <div>
                                ...
                                <?php if($GLOBALS['configHistoricoBoxIc4'] == 2){ ?>
                                    <?php //Sem formatação.?>
                                    <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                        <textarea name="informacao_complementar4" id="informacao_complementar4" class="AdmCampoTextoMultilinha01" style="width: 260px; height: 40px;"><?php echo $tbHistoricoIC4;?></textarea>
                                    <?php } ?>
                            ...
                            <div style="position: absolute; display: block; top: 10px; left: 0px; width: 280px; height: 85px; border: 1px solid #000;">
                                ...
                                <div style="position: relative; display: block; overflow: hidden; clear: both;">
                                    <div align="right" style="float: right;">
                                        <img onclick="iframeAdmForumPostagens.formularioSubmit('formForumPostagensAcoes', '', '', '');" src="img/btoExcluir.png" alt="<?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSite'], "siteBotaoExcluir"); ?>" style="cursor: pointer;" />
                                    </div>
                                    ...
                                    <div align="left" style="float: left;">
                                        <img onclick="iframeLoad('iframeManutencaoAjax', 'SiteAdmForumPostagensIndice.php?idTbForumTopicos=<?php echo $idTbHistorico; ?>&masterPageSiteSelect=LayoutSiteIFrame.php&habilitarListagem=1&habilitarInclusao=1&habilitarDetalhes=0&habilitarBusca=0', '', '', '');
                                                      divShow('divManutencaoAjax');
                                                      HTMLModificar01('linkManutencaoAjaxFechar', 'propriedade', 'onclick', 'divHide(\'divManutencaoAjax\');iframeRecarregar(\'iframeAdmForumPostagens\', \'\');');" src="img/btoIncluirTeste.png" alt="Incluir Teste" style="cursor: pointer;" />
                                    </div>
                                    ...
                                    <div style="text-align: center;">
                                        <img onclick="iframeLoad('iframeManutencaoAjax', 'SiteAdmForumPostagensIndice.php?idTbForumTopicos=<?php echo $idTbHistorico; ?>&masterPageSiteSelect=LayoutSiteIFrame.php&habilitarListagem=1&habilitarInclusao=0&habilitarDetalhes=0&habilitarBusca=0', '', '', '');
                                                      divShow('divManutencaoAjax');
                                                      HTMLModificar01('linkManutencaoAjaxFechar', 'propriedade', 'onclick', 'divHide(\'divManutencaoAjax\');iframeRecarregar(\'iframeAdmForumPostagens\', \'\');');"src="img/btoVisualizacaoMapa.png" alt="Visualizar Mapa" style="cursor: pointer;" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div style="position: absolute; display: block; top: 225px; left: 290px;">
                            <div align="left" class="AdmTexto01">
                            ...
                            <div>
                                ...
                                <?php if($GLOBALS['configHistoricoBoxIc6'] == 2){ ?>
                                    <?php //Sem formatação.?>
                                    <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                        <textarea name="informacao_complementar6" id="informacao_complementar6" class="AdmCampoTextoMultilinha01" style="width: 180px; height: 80px;"><?php echo $tbHistoricoIC6;?></textarea>
                                    <?php } ?>
                        ...
                        <!--Fixação.-->
                    	<div style="position: absolute; display: block; top: 340px; left: 5px; width: 470px; height: 70px; border: 1px solid #c31907;">
                            <!--sub títulos.-->
                            ...
                            <div style="position: absolute; display: block; top: 80px; left: 5px;">
                                ...
                                <div>
                                    ...
                                    <?php if($GLOBALS['configHistoricoBoxIc15'] == 2){ ?>
                                        <?php //Sem formatação.?>
                                        <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                            <textarea name="informacao_complementar15" id="informacao_complementar15" class="AdmCampoTextoMultilinha01" style="width: 450px;"><?php echo $tbHistoricoIC15;?></textarea>
                                        <?php } ?>
