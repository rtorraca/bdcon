    ...
    <form name="formProdutos" id="formProdutos" action="SiteAdmProdutosIndiceExe.php" method="post" enctype="multipart/form-data" class="FormularioDados01">
        ...
        <div style="position: relative; display: block; width: 100%;">
            ...
            <div style="float:right;">
                <img src="img/btoExcluir.png" onclick="formularioSubmit('formProdutosAcoes', '', '', '');" alt="<?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSite'], "siteBotaoExcluir"); ?>" style="cursor: pointer;" />
            </div>
        </div>
    </form>
    <br />
