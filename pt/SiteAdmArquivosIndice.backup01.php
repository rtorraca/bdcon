        ...
        Arquivos
            ...
            ?>
                <form name="formArquivosAcoes" id="formArquivosAcoes" action="SiteAdmRegistrosAcoesExe.php" method="post" class="FormularioTabela01">
                    ...
                    <div style="position: relative; display: block; width: 200px; height: 240px; overflow: scroll; background-color: #fff;">
            ...
            <div style="float: left;">
                <img onclick="divShow('divAdicionar');" src="img/btoAdicionar.png" alt="Adicionar" style="cursor: pointer;" />
            </div>
            
    </div>
    
    
    <div id="divAdicionar" style="position: absolute; display: none; top: 330px; left: 30px; width: 200px;">
        <form name="formArquivos" id="formArquivos" action="SiteAdmArquivosIndiceExe.php" method="post" enctype="multipart/form-data" class="FormularioDados01">
            ...
            <div>
                <div align="center">
                    <input type="image" name="submit" value="Submit" src="img/btoUpload.png" alt="<?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSite'], "siteBotaoUpload"); ?>" />
