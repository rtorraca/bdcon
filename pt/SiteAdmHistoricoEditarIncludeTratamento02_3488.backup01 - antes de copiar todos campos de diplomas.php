                        ...
                        <div style="position: absolute; display: block; top: 0px; left: 480px;">
                            ...
                            <div>
                                ...
                                <?php if($GLOBALS['configHistoricoBoxIc21'] == 2){ ?>
                                    <?php //Sem formatação.?>
                                    <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                        <textarea name="informacao_complementar21" id="informacao_complementar21" class="AdmCampoTextoMultilinha01" style="width: 470px; height: 420px;"><?php echo $tbHistoricoIC21;?></textarea>
                                    <?php } ?>
