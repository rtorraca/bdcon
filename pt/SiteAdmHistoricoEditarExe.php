...
//$dataHistorico = Funcoes::DataGravacaoSql($_POST["data_historico"], $GLOBALS['configSiteFormatoData']) . " " . date("H") . ":" . date("i") . ":" . date("s");
...
{
	//$dataHistorico = Funcoes::DataGravacaoSql(DbFuncoes::GetCampoGenerico01($id, "tb_historico", "data_historico"), $GLOBALS['configSiteFormatoData']);
	$dataHistorico = DbFuncoes::GetCampoGenerico01($id, "tb_historico", "data_historico");
}

$data1 = Funcoes::DataGravacaoSql($_POST["data1"], $GLOBALS['configSiteFormatoData']);
if($data1 == "")
{
	$data1 = NULL;	
}
$data2 = Funcoes::DataGravacaoSql($_POST["data2"], $GLOBALS['configSiteFormatoData']);
if($data2 == "")
{
	$data2 = NULL;	
}
$data3 = Funcoes::DataGravacaoSql($_POST["data3"], $GLOBALS['configSiteFormatoData']);
if($data3 == "")
{
	$data3 = NULL;	
}
$data4 = Funcoes::DataGravacaoSql($_POST["data4"], $GLOBALS['configSiteFormatoData']);
if($data4 == "")
{
	$data4 = NULL;	
}
$data5 = Funcoes::DataGravacaoSql($_POST["data5"], $GLOBALS['configSiteFormatoData']);
if($data5 == "")
{
	$data5 = NULL;	
}
...
$queryPadrao = "&masterPageSiteSelect=" . $masterPageSiteSelect . "&idTbHistoricoStatusSelect=" . $idTbHistoricoStatusSelect;
...
//Debug.
/*
echo "arrIdsHistoricoFiltroGenerico06=";
print_r($arrIdsHistoricoFiltroGenerico06);
echo "<br />";

echo "arrIdsHistoricoFiltroGenerico07=";
print_r($arrIdsHistoricoFiltroGenerico07);
echo "<br />";
*/
...
//----------
$strSqlHistoricoUpdate = "";
$strSqlHistoricoUpdate .= "UPDATE tb_historico ";
$strSqlHistoricoUpdate .= "SET ";
//$strSqlHistoricoUpdate .= "id = :id, ";
$strSqlHistoricoUpdate .= "id_parent = :id_parent, ";
$strSqlHistoricoUpdate .= "id_tb_cadastro_usuario = :id_tb_cadastro_usuario, ";
//if($configCadastroHistoricoDataEdicao == 1) //não funcionou
//{
//$strSqlHistoricoUpdate .= "data_historico = :data_historico, ";
//}
$strSqlHistoricoUpdate .= "data1 = :data1, ";
$strSqlHistoricoUpdate .= "data2 = :data2, ";
$strSqlHistoricoUpdate .= "data3 = :data3, ";
$strSqlHistoricoUpdate .= "data4 = :data4, ";
$strSqlHistoricoUpdate .= "data5 = :data5, ";

$strSqlHistoricoUpdate .= "assunto = :assunto, ";
$strSqlHistoricoUpdate .= "historico = :historico, ";
$strSqlHistoricoUpdate .= "id_tb_cadastro1 = :id_tb_cadastro1, ";
$strSqlHistoricoUpdate .= "id_tb_cadastro2 = :id_tb_cadastro2, ";
$strSqlHistoricoUpdate .= "id_tb_cadastro3 = :id_tb_cadastro3, ";
$strSqlHistoricoUpdate .= "id_tb_cadastro4 = :id_tb_cadastro4, ";
$strSqlHistoricoUpdate .= "id_tb_cadastro5 = :id_tb_cadastro5, ";
$strSqlHistoricoUpdate .= "id_tb_cadastro6 = :id_tb_cadastro6, ";
$strSqlHistoricoUpdate .= "id_tb_cadastro7 = :id_tb_cadastro7, ";
$strSqlHistoricoUpdate .= "id_tb_cadastro8 = :id_tb_cadastro8, ";
$strSqlHistoricoUpdate .= "id_tb_cadastro9 = :id_tb_cadastro9, ";
$strSqlHistoricoUpdate .= "id_tb_cadastro10 = :id_tb_cadastro10, ";
$strSqlHistoricoUpdate .= "informacao_complementar1 = :informacao_complementar1, ";
$strSqlHistoricoUpdate .= "informacao_complementar2 = :informacao_complementar2, ";
$strSqlHistoricoUpdate .= "informacao_complementar3 = :informacao_complementar3, ";
$strSqlHistoricoUpdate .= "informacao_complementar4 = :informacao_complementar4, ";
$strSqlHistoricoUpdate .= "informacao_complementar5 = :informacao_complementar5, ";
$strSqlHistoricoUpdate .= "informacao_complementar6 = :informacao_complementar6, ";
$strSqlHistoricoUpdate .= "informacao_complementar7 = :informacao_complementar7, ";
$strSqlHistoricoUpdate .= "informacao_complementar8 = :informacao_complementar8, ";
$strSqlHistoricoUpdate .= "informacao_complementar9 = :informacao_complementar9, ";
$strSqlHistoricoUpdate .= "informacao_complementar10 = :informacao_complementar10, ";
$strSqlHistoricoUpdate .= "informacao_complementar11 = :informacao_complementar11, ";
$strSqlHistoricoUpdate .= "informacao_complementar12 = :informacao_complementar12, ";
$strSqlHistoricoUpdate .= "informacao_complementar13 = :informacao_complementar13, ";
$strSqlHistoricoUpdate .= "informacao_complementar14 = :informacao_complementar14, ";
$strSqlHistoricoUpdate .= "informacao_complementar15 = :informacao_complementar15, ";
$strSqlHistoricoUpdate .= "informacao_complementar16 = :informacao_complementar16, ";
$strSqlHistoricoUpdate .= "informacao_complementar17 = :informacao_complementar17, ";
$strSqlHistoricoUpdate .= "informacao_complementar18 = :informacao_complementar18, ";
$strSqlHistoricoUpdate .= "informacao_complementar19 = :informacao_complementar19, ";
$strSqlHistoricoUpdate .= "informacao_complementar20 = :informacao_complementar20, ";
$strSqlHistoricoUpdate .= "informacao_complementar21 = :informacao_complementar21, ";
$strSqlHistoricoUpdate .= "informacao_complementar22 = :informacao_complementar22, ";
$strSqlHistoricoUpdate .= "informacao_complementar23 = :informacao_complementar23, ";
$strSqlHistoricoUpdate .= "informacao_complementar24 = :informacao_complementar24, ";
$strSqlHistoricoUpdate .= "informacao_complementar25 = :informacao_complementar25, ";
$strSqlHistoricoUpdate .= "informacao_complementar26 = :informacao_complementar26, ";
$strSqlHistoricoUpdate .= "informacao_complementar27 = :informacao_complementar27, ";
$strSqlHistoricoUpdate .= "informacao_complementar28 = :informacao_complementar28, ";
$strSqlHistoricoUpdate .= "informacao_complementar29 = :informacao_complementar29, ";
$strSqlHistoricoUpdate .= "informacao_complementar30 = :informacao_complementar30, ";
$strSqlHistoricoUpdate .= "informacao_complementar31 = :informacao_complementar31, ";
$strSqlHistoricoUpdate .= "informacao_complementar32 = :informacao_complementar32, ";
$strSqlHistoricoUpdate .= "informacao_complementar33 = :informacao_complementar33, ";
$strSqlHistoricoUpdate .= "informacao_complementar34 = :informacao_complementar34, ";
$strSqlHistoricoUpdate .= "informacao_complementar35 = :informacao_complementar35, ";
$strSqlHistoricoUpdate .= "informacao_complementar36 = :informacao_complementar36, ";
$strSqlHistoricoUpdate .= "informacao_complementar37 = :informacao_complementar37, ";
$strSqlHistoricoUpdate .= "informacao_complementar38 = :informacao_complementar38, ";
$strSqlHistoricoUpdate .= "informacao_complementar39 = :informacao_complementar39, ";
$strSqlHistoricoUpdate .= "informacao_complementar40 = :informacao_complementar40, ";
$strSqlHistoricoUpdate .= "informacao_complementar41 = :informacao_complementar41, ";
$strSqlHistoricoUpdate .= "informacao_complementar42 = :informacao_complementar42, ";
$strSqlHistoricoUpdate .= "informacao_complementar43 = :informacao_complementar43, ";
$strSqlHistoricoUpdate .= "informacao_complementar44 = :informacao_complementar44, ";
$strSqlHistoricoUpdate .= "informacao_complementar45 = :informacao_complementar45, ";
$strSqlHistoricoUpdate .= "informacao_complementar46 = :informacao_complementar46, ";
$strSqlHistoricoUpdate .= "informacao_complementar47 = :informacao_complementar47, ";
$strSqlHistoricoUpdate .= "informacao_complementar48 = :informacao_complementar48, ";
$strSqlHistoricoUpdate .= "informacao_complementar49 = :informacao_complementar49, ";
$strSqlHistoricoUpdate .= "informacao_complementar50 = :informacao_complementar50, ";
$strSqlHistoricoUpdate .= "informacao_complementar51 = :informacao_complementar51, ";
$strSqlHistoricoUpdate .= "informacao_complementar52 = :informacao_complementar52, ";
$strSqlHistoricoUpdate .= "informacao_complementar53 = :informacao_complementar53, ";
$strSqlHistoricoUpdate .= "informacao_complementar54 = :informacao_complementar54, ";
$strSqlHistoricoUpdate .= "informacao_complementar55 = :informacao_complementar55, ";
$strSqlHistoricoUpdate .= "informacao_complementar56 = :informacao_complementar56, ";
$strSqlHistoricoUpdate .= "informacao_complementar57 = :informacao_complementar57, ";
$strSqlHistoricoUpdate .= "informacao_complementar58 = :informacao_complementar58, ";
$strSqlHistoricoUpdate .= "informacao_complementar59 = :informacao_complementar59, ";
$strSqlHistoricoUpdate .= "informacao_complementar60 = :informacao_complementar60, ";
$strSqlHistoricoUpdate .= "id_tb_historico_status = :id_tb_historico_status ";
$strSqlHistoricoUpdate .= "WHERE id = :id ";
//echo "strSqlCategoriasUpdate = " . $strSqlHistoricoUpdate . "<br />";
//----------


$statementHistoricoUpdate = $dbSistemaConPDO->prepare($strSqlHistoricoUpdate);
...
*/
if ($statementHistoricoUpdate !== false)
{
	$statementHistoricoUpdate->execute(array(
		"id" => $id,
		"id_parent" => $idParent,
...
//Limpeza de objetos.
unset($strSqlHistoricoUpdate);
unset($statementHistoricoUpdate);
//----------
...
DbExcluir::ExcluirRegistrosGenerico02($id, 
									...
									"tipo_complemento", 
									"61");
if(!empty($arrIdsHistoricoFiltroGenerico50))
{
	for($countArray = 0; $countArray < count($arrIdsHistoricoFiltroGenerico50); $countArray++)
	{
		DbFuncoes::FiltrosGenericosGravar01($id, $arrIdsHistoricoFiltroGenerico50[$countArray], "61", "tb_historico_relacao_complemento", "id_tb_historico", "id_tb_historico_complemento");
	}
}
