                        ...
                        <div style="position: absolute; display: block; top: 90px; left: 5px;">
                            ...
                            <div class="AdmTexto01">
                                ...
                                <?php if($GLOBALS['configHistoricoFiltroGenerico63CaixaSelecao'] == 2){ ?>
                                    <select id="idsHistoricoFiltroGenerico63" name="idsHistoricoFiltroGenerico63[]" size="5" multiple="multiple" class="AdmCampoFiltroGenericoListBox01" style="height: 80px;">
                                        <?php 
                                        for($countArray = 0; $countArray < count($arrHistoricoFiltroGenerico63); $countArray++)
                                        {
                                        ?>
                            ...
                            <div style="position: absolute; display: block; top: 0px; left: 5px;">
                                ...
                                <div class="AdmTexto01">
                                    ...
                                    <?php if($GLOBALS['configHistoricoFiltroGenerico50CaixaSelecao'] == 2){ ?>
                                        <select id="idsHistoricoFiltroGenerico50" name="idsHistoricoFiltroGenerico50[]" size="5" multiple="multiple" class="AdmCampoFiltroGenericoListBox01" style="height: 50px;">
                                            <?php 
                                            for($countArray = 0; $countArray < count($arrHistoricoFiltroGenerico50); $countArray++)
                                            {
                                            ?>
                            ...
                            <div style="position: absolute; display: block; top: 0px; left: 250px;">
                                ...
                                <div class="AdmTexto01">
                                    ...
                                    <?php if($GLOBALS['configHistoricoFiltroGenerico51CaixaSelecao'] == 2){ ?>
                                        <select id="idsHistoricoFiltroGenerico51" name="idsHistoricoFiltroGenerico51[]" size="5" multiple="multiple" class="AdmCampoFiltroGenericoListBox01" style="height: 50px;">
                                            <?php 
                                            for($countArray = 0; $countArray < count($arrHistoricoFiltroGenerico51); $countArray++)
                                            {
                                            ?>
                                ...
                                <div style="position: absolute; display: block; top: 0px; left: 5px;">
                                    ...
                                    <div class="AdmTexto01">
                                        ...
                                        <?php if($GLOBALS['configHistoricoFiltroGenerico58CaixaSelecao'] == 2){ ?>
                                            <select id="idsHistoricoFiltroGenerico58" name="idsHistoricoFiltroGenerico58[]" size="5" multiple="multiple" class="AdmCampoFiltroGenericoListBox01" style="height: 50px;">
                                                <?php 
                                                for($countArray = 0; $countArray < count($arrHistoricoFiltroGenerico58); $countArray++)
                                                {
                                                ?>
                                ...
                                <div style="position: absolute; display: block; top: 0px; left: 240px;">
                                    ...
                                    <div class="AdmTexto01">
                                        ...
                                        <?php if($GLOBALS['configHistoricoFiltroGenerico59CaixaSelecao'] == 2){ ?>
                                            <select id="idsHistoricoFiltroGenerico59" name="idsHistoricoFiltroGenerico59[]" size="5" multiple="multiple" class="AdmCampoFiltroGenericoListBox01" style="height: 50px;">
                                                <?php 
                                                for($countArray = 0; $countArray < count($arrHistoricoFiltroGenerico59); $countArray++)
                                                {
                                                ?>
                            ...
                            <div style="position: absolute; display: block; top: 180px; left: 5px;">
                                ...
                                <div class="AdmTexto01">
                                    ...
                                    <?php if($GLOBALS['configHistoricoFiltroGenerico61CaixaSelecao'] == 2){ ?>
                                        <select id="idsHistoricoFiltroGenerico61" name="idsHistoricoFiltroGenerico61[]" size="5" multiple="multiple" class="AdmCampoFiltroGenericoListBox01" style="height: 50px;">
                                            <?php 
                                            for($countArray = 0; $countArray < count($arrHistoricoFiltroGenerico61); $countArray++)
                                            {
                                            ?>
                            ...
                            <div style="position: absolute; display: block; top: 250px; left: 5px;">
                                ...
                                <div>
                                    ...
                                    <?php if($GLOBALS['configHistoricoBoxIc56'] == 2){ ?>
                                        <?php //Sem formatação.?>
                                        <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                            <textarea name="informacao_complementar56" id="informacao_complementar56" class="AdmCampoTextoMultilinha01" style="width: 450px; height: 160px;"><?php echo $tbHistoricoIC56;?></textarea>
                                        <?php } ?>
