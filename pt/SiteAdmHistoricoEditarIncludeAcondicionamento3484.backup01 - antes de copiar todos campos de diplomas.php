                            ...
                            <div style="position: absolute; display: block; top: 180px; left: 5px;">
                                ...
                                <div>
                                    ...
                                    <?php if($GLOBALS['configHistoricoBoxIc54'] == 2){ ?>
                                        <?php //Sem formatação.?>
                                        <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                            <textarea name="informacao_complementar54" id="informacao_complementar54" class="AdmCampoTextoMultilinha01" style="width: 450px; height: 260px;"><?php echo $tbHistoricoIC54;?></textarea>
                                        <?php } ?>
                            ...
                            <div style="position: absolute; display: block; top: 260px; left: 5px;">
                                ...
                                <div>
                                    ...
                                    <?php if($GLOBALS['configHistoricoBoxIc58'] == 2){ ?>
                                        <?php //Sem formatação.?>
                                        <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                            <textarea name="informacao_complementar58" id="informacao_complementar58" class="AdmCampoTextoMultilinha01" style="width: 450px; height: 200px;"><?php echo $tbHistoricoIC58;?></textarea>
                                        <?php } ?>
