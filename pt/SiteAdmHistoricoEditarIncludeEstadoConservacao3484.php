                        ...
                        <!--Encadernação.-->
                    	<div class="DivCantoArredondado02" style="position: absolute; display: block; top: 20px; left: 490px; width: 470px; height: 425px; border: 1px solid #c31907;">
                            <!--sub títulos.-->
                            ...
                            <div style="position: absolute; display: block; top: 240px; left: 15px;">
                                ...
                                <div>
                                    ...
                                    <?php if($GLOBALS['configHistoricoBoxIc56'] == 2){ ?>
                                        <?php //Sem formatação.?>
                                        <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                            <textarea name="informacao_complementar56" id="informacao_complementar56" class="AdmCampoTextoMultilinha01" style="width: 440px; height: 160px;"><?php echo $tbHistoricoIC56;?></textarea>
                                        <?php } ?>
