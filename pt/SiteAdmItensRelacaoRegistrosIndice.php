...
$paginaRetorno = "SiteAdmItensRelacaoRegistrosIndice.php";
                                ...
                                <table width="100%" class="AdmTabelaDados01">
                                  <tr class="AdmTbFundoEscuro">
                                    ...
                                    <td width="230" class="TabelaDados01Celula">
                                        <div align="center" class="AdmTexto02">
                                            <?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSite'], "siteItensRelacaoRegistroValor"); ?>
                                        </div>
                                    </td>
                                    <?php } ?>
                                  ...
                                  <tr class="AdmTbFundoClaro">
                                    ...
                                    <td class="TabelaDados01Celula">
                                        ...
                                        <div class="AdmTexto01" style="display: none;">
                                            <?php if($GLOBALS['habilitarProdutosFotos'] == 1){ ?>
                                                [
                                                <a href="ArquivosIndice.php?idParent=<?php echo $linhaProdutos['id'];?>&tipoArquivo=1&masterPageSiteSelect=LayoutSistemaSemMenu.php&detalhe01=<?php echo Funcoes::ConteudoMascaraLeitura($linhaProdutos['produto']);?>&detalhe02=" target="_blank" class="AdmLinks01">
                                            ...
                                            <?php if($GLOBALS['habilitarProdutosVideos'] == 1){ ?>
                                                [
                                                <a href="ArquivosIndice.php?idParent=<?php echo $linhaProdutos['id'];?>&tipoArquivo=2&masterPageSiteSelect=LayoutSistemaSemMenu.php&detalhe01=<?php echo Funcoes::ConteudoMascaraLeitura($linhaProdutos['produto']);?>&detalhe02=" target="_blank" class="AdmLinks01">
                                            ...
                                            <?php if($GLOBALS['habilitarProdutosArquivos'] == 1){ ?>
                                                [
                                                <a href="ArquivosIndice.php?idParent=<?php echo $linhaProdutos['id'];?>&tipoArquivo=3&masterPageSiteSelect=LayoutSistemaSemMenu.php&detalhe01=<?php echo Funcoes::ConteudoMascaraLeitura($linhaProdutos['produto']);?>&detalhe02=" target="_blank" class="AdmLinks01">
                                            ...
                                            <?php if($GLOBALS['habilitarProdutosZip'] == 1){ ?>
                                                [
                                                <a href="ArquivosIndice.php?idParent=<?php echo $linhaProdutos['id'];?>&tipoArquivo=4&masterPageSiteSelect=LayoutSistemaSemMenu.php&detalhe01=<?php echo Funcoes::ConteudoMascaraLeitura($linhaProdutos['produto']);?>&detalhe02=" target="_blank" class="AdmLinks01">
                                            ...
                                            <?php if($GLOBALS['habilitarProdutosSwfs'] == 1){ ?>
                                                [
                                                <a href="ArquivosIndice.php?idParent=<?php echo $linhaProdutos['id'];?>&tipoArquivo=5&masterPageSiteSelect=LayoutSistemaSemMenu.php&detalhe01=<?php echo Funcoes::ConteudoMascaraLeitura($linhaProdutos['produto']);?>&detalhe02=" target="_blank" class="AdmLinks01">
                                            ...
                                            <?php if($GLOBALS['habilitarProdutosConteudo'] == 1){ ?>
                                                [
                                                <a href="ConteudoIndice.php?idParentConteudo=<?php echo $linhaProdutos['id'];?>&masterPageSiteSelect=LayoutSistemaSemMenu.php&detalhe01=<?php echo Funcoes::ConteudoMascaraLeitura($linhaProdutos['produto']);?>&detalhe02=" target="_blank" class="AdmLinks01">
                                            ...
                                            <?php if($GLOBALS['habilitarProdutosHistorico'] == 1){ ?>
                                                [
                                                <a href="HistoricoIndice.php?idParent=<?php echo $linhaProdutos['id'];?>&masterPageSiteSelect=LayoutSistemaSemMenu.php&detalhe01=<?php echo Funcoes::ConteudoMascaraLeitura($linhaProdutos['produto']);?>&detalhe02=" target="_blank" class="AdmLinks01">
                                            ...
                                            <?php if($GLOBALS['habilitarProdutosModulos'] == 1){ ?>
                                                [
                                                <a href="ModulosIndice.php?idParentModulos=<?php echo $linhaProdutos['id'];?>&masterPageSiteSelect=LayoutSistemaSemMenu.php&detalhe01=<?php echo Funcoes::ConteudoMascaraLeitura($linhaProdutos['produto']);?>&detalhe02=" target="_blank" class="AdmLinks01">
                                            ...
                                            <?php if($GLOBALS['habilitarProdutosAulas'] == 1){ ?>
                                                [
                                                <a href="AulasIndice.php?idParentAulas=<?php echo $linhaProdutos['id'];?>&masterPageSiteSelect=LayoutSistemaSemMenu.php&detalhe01=<?php echo Funcoes::ConteudoMascaraLeitura($linhaProdutos['produto']);?>&detalhe02=" target="_blank" class="AdmLinks01">
                                        ...
                                        <?php if($GLOBALS['habilitarProdutosCadastroUsuario'] == 1){ ?>
                                            <div class="AdmTexto01" style="display: none;">
                                                <?php if($linhaProdutos['id_tb_cadastro_usuario'] <> 0){ ?>
                                                    ...
                                                    <a href="SiteAdmCadastroAdministrar.php?idTbCadastro=<?php echo $linhaProdutos['id_tb_cadastro_usuario'];?>&masterPageSiteSelect=LayoutSistemaSemMenu.php" target="_blank" class="AdmLinks01">
                                    ...
                                    <td class="TabelaDados01Celula">
                                        <div align="center" class="AdmTexto01">
											<?php echo Funcoes::ConteudoMascaraLeitura($GLOBALS['configSistemaMoeda'], "IncludeConfig"); ?>
                                            <input type="text" name="valor_<?php echo $linhaProdutos['id'];?>" id="valor_<?php echo $linhaProdutos['id'];?>" class="AdmCampoNumerico02" maxlength="255" value="<?php echo $tbItensRelacaoRegistrosValor; ?>" />
                                    ...
                                    <td class="<?php if($linhaProdutos['ativacao'] == 1){/*echo "AdmTbFundoClaro";*/}else{echo "AdmTbFundoDesativado";}?> TabelaDados01Celula">
                                        <div align="center" class="AdmTexto01">
                                    ...
                                    <?php if($GLOBALS['habilitarProdutosAtivacaoPromocoes'] == 1){ ?>
                                    <td class="<?php if($linhaProdutos['ativacao_promocao'] == 1){/*echo "AdmTbFundoClaro";*/}else{echo "AdmTbFundoDesativado";}?> TabelaDados01Celula" style="display: none;">
                                        <div align="center" class="AdmTexto01">
                                    ...
                                    <?php if($GLOBALS['habilitarProdutosAtivacaoHome'] == 1){ ?>
                                    <td class="<?php if($linhaProdutos['ativacao_home'] == 1){/*echo "AdmTbFundoClaro";*/}else{echo "AdmTbFundoDesativado";}?> TabelaDados01Celula" style="display: none;">
                                        <div align="center" class="AdmTexto01">
                                    ...
                                    <?php if($GLOBALS['habilitarProdutosAtivacaoCategoria'] == 1){ ?>
                                    <td class="<?php if($linhaProdutos['ativacao_home_categoria'] == 1){/*echo "AdmTbFundoClaro";*/}else{echo "AdmTbFundoDesativado";}?> TabelaDados01Celula" style="display: none;">
                                        <div align="center" class="AdmTexto01">
                                    ...
                                    <?php if($GLOBALS['habilitarProdutosAtivacaoAcesso'] == 1){ ?>
                                    <td class="<?php if($linhaProdutos['acesso_restrito'] == 0){/*echo "AdmTbFundoClaro";*/}else{echo "AdmTbFundoDesativado";}?> TabelaDados01Celula" style="display: none;">
                                        <div align="center" class="AdmTexto01">
                        ...
                        ?>
                            ...
                            ?>
                              <tr class="AdmTbFundoClaro">
                                ...
                                <td class="TabelaDados01Celula">
                                    <div align="center" class="AdmTexto01">
                                        <input name="idsRegistrosSelecionar[]" type="checkbox" value="<?php echo $linhaCategoriasNivel1['id'];?>" class="AdmCampoCheckBox01"<?php if(in_array($linhaCategoriasNivel1['id'], $arrItensRelacaoRegistrosSelect9, true) == true){?> checked="checked"<?php } ?> />
                                    </div>
                                </td>
                              </tr>
							<?php } ?>
                        ...
                        ?>
                            ...
                            ?>
                              <tr class="AdmTbFundoClaro">
                                ...
                                <td class="TabelaDados01Celula">
                                    <div align="center" class="AdmTexto01">
                                        <input name="idsRegistrosSelecionar[]" type="checkbox" value="<?php echo $linhaPaginas['id'];?>" class="AdmCampoCheckBox01"<?php if(in_array($linhaPaginas['id'], $arrItensRelacaoRegistrosSelect26, true) == true){?> checked="checked"<?php } ?> />
                                    </div>
                                </td>
                              </tr>
							<?php } ?>
