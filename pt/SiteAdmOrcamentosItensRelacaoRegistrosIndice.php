...
$paginaRetorno = "SiteAdmOrcamentosItensRelacaoRegistrosIndice.php";
    ...
    <?php if($tipoDiagramacao == "1"){ ?>
        ...
        ?>
            <div style="position: relative; display: block; overflow: hidden;">
                <form name="formOrcamentosItensRelacaoRegistrosIndice" id="formOrcamentosItensRelacaoRegistrosIndice" action="SiteAdmOrcamentosItensRegistrosAcoesExe.php" method="post" class="FormularioTabela01">
                                      ...
                                      <tr class="TbFundoClaro">
                                        ...
                                        <td width="1" class="AdmTabelaDados01Celula">
                                            <div align="right" class="AdmTexto01">
                                                ...
                                                {
                                                    $quantidade = DbFuncoes::GetCampoGenerico06("ce_orcamentos_itens_relacao_registros", 
                                                                                                "quantidade", 
                                                                                                "id_ce_orcamentos_itens", 
                                                                                                $idCeOrcamentosItens, 
                                                                                                "", 
    ...
    <?php if($tipoDiagramacao == "2"){ ?>
        <div style="position: relative; display: block; overflow: hidden;">
            ...
            if ($statementOrcamentosItensRelacaoRegistrosSelect !== false)
            {
                ...
                */
                ...
                //{
                    ...
                    $statementOrcamentosItensRelacaoRegistrosSelect->bindParam(':id_ce_orcamentos_itens', $idCeOrcamentosItens, PDO::PARAM_STR);
                //}
            ...
            ?>	
				...
				?>
                <form name="formOrcamentosItensRelacaoRegistrosIndice2" id="formOrcamentosItensRelacaoRegistrosIndice2" action="SiteAdmRegistrosAcoesExe.php" method="post" class="FormularioTabela01">
                    <input name="idCeOrcamentos" id="idCeOrcamentos" type="hidden" value="<?php echo $idCeOrcamentos; ?>" />
                    <input name="idCeOrcamentosFichas" id="idCeOrcamentosFichas" type="hidden" value="<?php echo $idCeOrcamentosFichas; ?>" />
                    <input name="idCeOrcamentosItens" id="idCeOrcamentosItens" type="hidden" value="<?php echo $idCeOrcamentosItens; ?>" />
                    <input name="tipoCategoria" id="tipoCategoria" type="hidden" value="<?php echo $tipoCategoria; ?>" />
                    <input name="strTabela" id="strTabela" type="hidden" value="ce_orcamentos_itens_relacao_registros" />
                    ...
                    <table class="AdmTabelaDados01" width="100%">
                        ...
                        {
							$tbProdutosProduto = "";
							$tbProdutosProduto = DbFuncoes::GetCampoGenerico01($linhaOrcamentosItensRelacaoRegistros["id_registro"], "tb_produtos", "produto");
							
							$tbProdutosImagem = "";
							$tbProdutosImagem = DbFuncoes::GetCampoGenerico01($linhaOrcamentosItensRelacaoRegistros["id_registro"], "tb_produtos", "imagem");
                        ...
                        ?>
                            ...
                            <tr class="AdmTbFundoClaro">
                                ...
                                <td class="AdmTabelaDados01Celula">
                                    <div align="center" class="AdmTexto01">
                                        <input name="idsRegistrosExcluir[]" type="checkbox" value="<?php echo $linhaOrcamentosItensRelacaoRegistros['id'];?>" class="AdmCampoCheckBox01" />
                                    </div>
                                </td>
                            </tr>
                        <?php } ?>
