...
<?php ob_start(); /*cphConteudoPrincipal*/ ?>
    ...
    <?php //Diagramação 02 - div.?>
    <?php //**************************************************************************************?>
    <div style="position: relative; display: block; overflow: hidden;">
		<?php if($GLOBALS['habilitarHistoricoFiltroGenerico01'] == 1){ ?>
            <div class="AdmDetalhesConteudoDivFileira01">
                <div class="AdmDetalhesSubtitulo AdmDetalhesConteudoDiv">
                    <?php echo Funcoes::ConteudoMascaraLeitura($GLOBALS['configHistoricoFiltroGenerico01Nome'], "IncludeConfig"); ?>:
                </div>
                <div align="left" class="AdmDetalhesConteudo AdmDetalhesConteudoDiv">
                    <?php
                    //Loop pelos resultados.
                    foreach($resultadoHistoricoComplemento as $linhaHistoricoComplemento)
                    {
                ...
                <div class="AdmDetalhesConteudoSeparador">
                </div>
            </div>
        <?php } ?>
