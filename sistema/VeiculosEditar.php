...
<?php ob_start(); /*cphConteudoCabecalho*/ ?>
    <div align="left" class="TextoTitulo01">
    	<?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaVeiculosTituloEditar"); ?> - <?php echo $tbVeiculosProduto; ?> - 
...
<?php ob_start(); /*cphConteudoPrincipal*/ ?>
    ...
    <form name="formVeiculosEditar" id="formVeiculosEditar" action="VeiculosEditarExe.php" method="post" enctype="multipart/form-data" class="FormularioDados01">
        <table class="TabelaCampos01">
            <tr>
                <td class="TbFundoEscuro" colspan="4">
                    <div align="center" class="Texto02">
                        <strong>
                            <?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaVeiculosTbVeiculosEditar"); ?>
                        </strong>
                    </div>
                </td>
            </tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <select name="id_tb_cadastro_usuario" id="id_tb_cadastro_usuario" class="CampoDropDownMenu01">
                            <option value="0"<?php if($tbVeiculosIdTbCadastroUsuario == 0){ ?> selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemNenhumDropDown"); ?></option>
                            <?php 
            ...
            <tr>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula"<?php if($GLOBALS['habilitarVeiculosNClassificacao'] <> "1"){ ?> colspan="3"<?php } ?>>
                    <div align="left">
                        <select name="modalidade" id="modalidade" class="CampoDropDownMenu01">
                            <option value="0"<?php if($tbVeiculosModalidade == 0){ ?> selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaVeiculosModalidade0"); ?></option>
                            <option value="1"<?php if($tbVeiculosModalidade == 1){ ?> selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaVeiculosModalidade1"); ?></option>
                            <option value="2"<?php if($tbVeiculosModalidade == 2){ ?> selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaVeiculosModalidade2"); ?></option>
                        </select>
                    </div>
                </td>
                ...
                <td class="TbFundoClaro TabelaColuna01 TabelaCampos01Celula">
                    <div>
                        <input type="text" name="n_classificacao" id="n_classificacao" class="CampoNumerico01" maxlength="10" value="<?php echo $tbVeiculosNClassificacao; ?>" />
                    </div>
                </td>
                <?php } ?>
            </tr>
            ...
            <tr>
                ...
                <td class="TbFundoClaro">
                    <div align="left">
						...
						<?php if($GLOBALS['configDataTipoCampo'] == 1){ ?>
                            ...
                            <input type="text" name="data_publicacao" id="data_publicacao" class="CampoData01" maxlength="10" value="<?php echo $tbVeiculosDataPublicacao; ?>" />
                ...
                <td class="TbFundoClaro TabelaColuna01">
                    <div align="left">
                        <input type="text" name="codigo" id="codigo" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosCodigo; ?>" />
                    </div>
                </td>
            </tr>
                    ...
                    <div align="left">
                    	...
                    	<?php if($GLOBALS['configTipoCampoVeiculosData1'] == 1){ ?>
                            <?php if($GLOBALS['configDataTipoCampo'] == 1){ ?>
                                ...
                                <input type="text" name="data1" id="data1" class="CampoData01" maxlength="10" value="<?php echo $tbVeiculosData1; ?>" />
                                <?php //echo Funcoes::DataGravacaoSql("15/02/1980", 1); ?>
                            <?php } ?>
                        <?php } ?>
						<?php //---------------------- ?>
                    ...
                    <div align="left">
                    	...
                    	<?php if($GLOBALS['configTipoCampoVeiculosData2'] == 1){ ?>
                            <?php if($GLOBALS['configDataTipoCampo'] == 1){ ?>
                                ...
                                <input type="text" name="data2" id="data2" class="CampoData01" maxlength="10" value="<?php echo $tbVeiculosData2; ?>" />
                                <?php //echo Funcoes::DataGravacaoSql("15/02/1980", 1); ?>
                            <?php } ?>
                        <?php } ?>
						<?php //---------------------- ?>
                    ...
                    <div align="left">
                    	...
                    	<?php if($GLOBALS['configTipoCampoVeiculosData3'] == 1){ ?>
                            <?php if($GLOBALS['configDataTipoCampo'] == 1){ ?>
                                ...
                                <input type="text" name="data3" id="data3" class="CampoData01" maxlength="10" value="<?php echo $tbVeiculosData3; ?>" />
                                <?php //echo Funcoes::DataGravacaoSql("15/02/1980", 1); ?>
                            <?php } ?>
                        <?php } ?>
						<?php //---------------------- ?>
                    ...
                    <div align="left">
                    	...
                    	<?php if($GLOBALS['configTipoCampoVeiculosData4'] == 1){ ?>
                            <?php if($GLOBALS['configDataTipoCampo'] == 1){ ?>
                                ...
                                <input type="text" name="data4" id="data4" class="CampoData01" maxlength="10" value="<?php echo $tbVeiculosData4; ?>" />
                                <?php //echo Funcoes::DataGravacaoSql("15/02/1980", 1); ?>
                            <?php } ?>
                        <?php } ?>
						<?php //---------------------- ?>
                    ...
                    <div align="left">
                    	...
                    	<?php if($GLOBALS['configTipoCampoVeiculosData5'] == 1){ ?>
                            <?php if($GLOBALS['configDataTipoCampo'] == 1){ ?>
                                ...
                                <input type="text" name="data5" id="data5" class="CampoData01" maxlength="10" value="<?php echo $tbVeiculosData5; ?>" />
                                <?php //echo Funcoes::DataGravacaoSql("15/02/1980", 1); ?>
                            <?php } ?>
                        <?php } ?>
						<?php //---------------------- ?>
                    ...
                    <div align="left">
                    	...
                    	<?php if($GLOBALS['configTipoCampoVeiculosData6'] == 1){ ?>
                            <?php if($GLOBALS['configDataTipoCampo'] == 1){ ?>
                                ...
                                <input type="text" name="data6" id="data6" class="CampoData01" maxlength="10" value="<?php echo $tbVeiculosData6; ?>" />
                                <?php //echo Funcoes::DataGravacaoSql("15/02/1980", 1); ?>
                            <?php } ?>
                        <?php } ?>
						<?php //---------------------- ?>
                    ...
                    <div align="left">
                    	...
                    	<?php if($GLOBALS['configTipoCampoVeiculosData7'] == 1){ ?>
                            <?php if($GLOBALS['configDataTipoCampo'] == 1){ ?>
                                ...
                                <input type="text" name="data7" id="data7" class="CampoData01" maxlength="10" value="<?php echo $tbVeiculosData7; ?>" />
                                <?php //echo Funcoes::DataGravacaoSql("15/02/1980", 1); ?>
                            <?php } ?>
                        <?php } ?>
						<?php //---------------------- ?>
                    ...
                    <div align="left">
                    	...
                    	<?php if($GLOBALS['configTipoCampoVeiculosData8'] == 1){ ?>
                            <?php if($GLOBALS['configDataTipoCampo'] == 1){ ?>
                                ...
                                <input type="text" name="data8" id="data8" class="CampoData01" maxlength="10" value="<?php echo $tbVeiculosData8; ?>" />
                                <?php //echo Funcoes::DataGravacaoSql("15/02/1980", 1); ?>
                            <?php } ?>
                        <?php } ?>
						<?php //---------------------- ?>
                    ...
                    <div align="left">
                    	...
                    	<?php if($GLOBALS['configTipoCampoVeiculosData9'] == 1){ ?>
                            <?php if($GLOBALS['configDataTipoCampo'] == 1){ ?>
                                ...
                                <input type="text" name="data9" id="data9" class="CampoData01" maxlength="10" value="<?php echo $tbVeiculosData9; ?>" />
                                <?php //echo Funcoes::DataGravacaoSql("15/02/1980", 1); ?>
                            <?php } ?>
                        <?php } ?>
						<?php //---------------------- ?>
                    ...
                    <div align="left">
                    	...
                    	<?php if($GLOBALS['configTipoCampoVeiculosData10'] == 1){ ?>
                            <?php if($GLOBALS['configDataTipoCampo'] == 1){ ?>
                                ...
                                <input type="text" name="data10" id="data10" class="CampoData01" maxlength="10" value="<?php echo $tbVeiculosData10; ?>" />
                                <?php //echo Funcoes::DataGravacaoSql("15/02/1980", 1); ?>
                            <?php } ?>
                        <?php } ?>
						<?php //---------------------- ?>
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div align="left" class="Texto01">
                    	<input type="text" name="veiculo" id="veiculo" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosVeiculo; ?>" />
                    </div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div align="left" class="Texto01">
						...
						?>
                        	<div>
                                <input name="idsVeiculosTipo[]" type="checkbox" value="<?php echo $arrVeiculosTipo[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosTipo[$countArray][0], $arrVeiculosTipoSelecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosTipo[$countArray][1];?>
                            </div>
                        <?php 
						}
						?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico01CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico01[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico01[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico01[$countArray][0], $arrVeiculosFiltroGenerico01Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico01[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico02CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico02[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico02[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico02[$countArray][0], $arrVeiculosFiltroGenerico02Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico02[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico03CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico03[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico03[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico03[$countArray][0], $arrVeiculosFiltroGenerico03Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico03[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico04CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico04[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico04[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico04[$countArray][0], $arrVeiculosFiltroGenerico04Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico04[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico05CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico05[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico05[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico05[$countArray][0], $arrVeiculosFiltroGenerico05Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico05[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico06CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico06[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico06[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico06[$countArray][0], $arrVeiculosFiltroGenerico06Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico06[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico07CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico07[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico07[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico07[$countArray][0], $arrVeiculosFiltroGenerico07Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico07[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico08CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico08[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico08[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico08[$countArray][0], $arrVeiculosFiltroGenerico08Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico08[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico09CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico09[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico09[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico09[$countArray][0], $arrVeiculosFiltroGenerico09Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico09[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico10CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico10[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico10[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico10[$countArray][0], $arrVeiculosFiltroGenerico10Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico10[$countArray][1];?>
                                </div>
                            <?php 
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico11CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico11[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico11[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico11[$countArray][0], $arrVeiculosFiltroGenerico11Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico11[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico12CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico12[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico12[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico12[$countArray][0], $arrVeiculosFiltroGenerico12Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico12[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico13CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico13[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico13[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico13[$countArray][0], $arrVeiculosFiltroGenerico13Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico13[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico14CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico14[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico14[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico14[$countArray][0], $arrVeiculosFiltroGenerico14Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico14[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico15CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico15[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico15[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico15[$countArray][0], $arrVeiculosFiltroGenerico15Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico15[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico16CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico16[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico16[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico16[$countArray][0], $arrVeiculosFiltroGenerico16Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico16[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico17CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico17[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico17[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico17[$countArray][0], $arrVeiculosFiltroGenerico17Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico17[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico18CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico18[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico18[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico18[$countArray][0], $arrVeiculosFiltroGenerico18Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico18[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico19CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico19[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico19[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico19[$countArray][0], $arrVeiculosFiltroGenerico19Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico19[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <?php if($GLOBALS['configVeiculosFiltroGenerico20CaixaSelecao'] == 1){ ?>
                            ...
                            ?>
                                <div>
                                    <input name="idsVeiculosFiltroGenerico20[]" type="checkbox" value="<?php echo $arrVeiculosFiltroGenerico20[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrVeiculosFiltroGenerico20[$countArray][0], $arrVeiculosFiltroGenerico20Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrVeiculosFiltroGenerico20[$countArray][1];?>
                                </div>
                            <?php 
                            }
                            ?>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div>
                        ...
                        <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                            <textarea name="descricao" id="descricao" class="CampoTextoMultilinha01"><?php echo $tbVeiculosDescricao;?></textarea>
                        <?php } ?>
            ...
            <tr>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula">
                    <div align="left">
                        <select name="portas" id="portas" class="CampoDropDownMenu01">
                            <option value="0"<?php if($tbVeiculosPortas == 0){ ?> selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaVeiculosPortas0"); ?></option>
                ...
                <td class="TbFundoClaro TabelaColuna01 TabelaCampos01Celula">
                    <div class="Texto01">
                        <input type="text" name="kilometragem" id="kilometragem" class="CampoNumerico02" maxlength="10" value="<?php echo $tbVeiculosKilometragem;?>" />
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div>
                    	<input type="text" name="placa" id="placa" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosPlaca;?>" />
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <select name="id_tb_cadastro1" id="id_tb_cadastro1" class="CampoDropDownMenu01">
                            <option value="0"<?php if($tbVeiculosIdTbCadastro1 == 0){ ?>selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemNenhumDropDown"); ?></option>
                            <?php 
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <select name="id_tb_cadastro2" id="id_tb_cadastro2" class="CampoDropDownMenu01">
                            <option value="0"<?php if($tbVeiculosIdTbCadastro2 == 0){ ?>selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemNenhumDropDown"); ?></option>
                            <?php 
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <select name="id_tb_cadastro3" id="id_tb_cadastro3" class="CampoDropDownMenu01">
                            <option value="0"<?php if($tbVeiculosIdTbCadastro3 == 0){ ?>selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemNenhumDropDown"); ?></option>
                            <?php 
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <select name="id_tb_cadastro4" id="id_tb_cadastro4" class="CampoDropDownMenu01">
                            <option value="0"<?php if($tbVeiculosIdTbCadastro4 == 0){ ?>selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemNenhumDropDown"); ?></option>
                            <?php 
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <select name="id_tb_cadastro5" id="id_tb_cadastro5" class="CampoDropDownMenu01">
                            <option value="0"<?php if($tbVeiculosIdTbCadastro5 == 0){ ?>selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemNenhumDropDown"); ?></option>
                            <?php 
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc1'] == 1){ ?>
                            <input type="text" name="informacao_complementar1" id="informacao_complementar1" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC1;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc1'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar1" id="informacao_complementar1" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC1;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc2'] == 1){ ?>
                            <input type="text" name="informacao_complementar2" id="informacao_complementar2" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC2;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc2'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar2" id="informacao_complementar2" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC2;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc3'] == 1){ ?>
                            <input type="text" name="informacao_complementar3" id="informacao_complementar3" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC3;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc3'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar3" id="informacao_complementar3" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC3;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc4'] == 1){ ?>
                            <input type="text" name="informacao_complementar4" id="informacao_complementar4" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC4;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc4'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar4" id="informacao_complementar4" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC4;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc5'] == 1){ ?>
                            <input type="text" name="informacao_complementar5" id="informacao_complementar5" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC5;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc5'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar5" id="informacao_complementar5" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC5;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc6'] == 1){ ?>
                            ...
                            <input type="text" name="informacao_complementar6" id="informacao_complementar6" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC6;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc6'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar6" id="informacao_complementar6" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC6;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc7'] == 1){ ?>
                            <input type="text" name="informacao_complementar7" id="informacao_complementar7" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC7;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc2'] == 7){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar7" id="informacao_complementar7" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC7;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc8'] == 1){ ?>
                            <input type="text" name="informacao_complementar8" id="informacao_complementar8" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC8;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc8'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar8" id="informacao_complementar8" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC8;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc9'] == 1){ ?>
                            <input type="text" name="informacao_complementar9" id="informacao_complementar9" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC9;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc9'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar9" id="informacao_complementar9" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC9;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc10'] == 1){ ?>
                            <input type="text" name="informacao_complementar10" id="informacao_complementar10" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC10;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc10'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar10" id="informacao_complementar10" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC10;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc11'] == 1){ ?>
                            <input type="text" name="informacao_complementar11" id="informacao_complementar11" class="CampoTexto01" maxlength="255"  value="<?php echo $tbVeiculosIC11;?>"/>
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc11'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar11" id="informacao_complementar11" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC11;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc12'] == 1){ ?>
                            <input type="text" name="informacao_complementar12" id="informacao_complementar12" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC12;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc12'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar12" id="informacao_complementar12" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC12;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc13'] == 1){ ?>
                            <input type="text" name="informacao_complementar13" id="informacao_complementar13" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC13;?>">
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc13'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar13" id="informacao_complementar13" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC13;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc14'] == 1){ ?>
                            <input type="text" name="informacao_complementar14" id="informacao_complementar14" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC14;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc14'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar14" id="informacao_complementar14" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC14;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc15'] == 1){ ?>
                            <input type="text" name="informacao_complementar15" id="informacao_complementar15" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC15;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc15'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar15" id="informacao_complementar15" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC15;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc16'] == 1){ ?>
                            <input type="text" name="informacao_complementar16" id="informacao_complementar16" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC16;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc16'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar16" id="informacao_complementar16" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC16;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc17'] == 1){ ?>
                            <input type="text" name="informacao_complementar17" id="informacao_complementar17" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC17;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc12'] == 7){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar17" id="informacao_complementar17" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC17;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc18'] == 1){ ?>
                            <input type="text" name="informacao_complementar18" id="informacao_complementar18" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC18;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc18'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar18" id="informacao_complementar18" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC18;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc19'] == 1){ ?>
                            <input type="text" name="informacao_complementar19" id="informacao_complementar19" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC19;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc19'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar19" id="informacao_complementar19" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC19;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc20'] == 1){ ?>
                            <input type="text" name="informacao_complementar20" id="informacao_complementar20" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC20;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc20'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar20" id="informacao_complementar20" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC20;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc21'] == 1){ ?>
                            <input type="text" name="informacao_complementar21" id="informacao_complementar21" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC21;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc21'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar21" id="informacao_complementar21" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC21;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc22'] == 1){ ?>
                            <input type="text" name="informacao_complementar22" id="informacao_complementar22" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC22;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc22'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar22" id="informacao_complementar22" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC22;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc23'] == 1){ ?>
                            <input type="text" name="informacao_complementar23" id="informacao_complementar23" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC23;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc23'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar23" id="informacao_complementar23" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC23;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc24'] == 1){ ?>
                            <input type="text" name="informacao_complementar24" id="informacao_complementar24" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC24;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc24'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar24" id="informacao_complementar24" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC24;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc25'] == 1){ ?>
                            <input type="text" name="informacao_complementar25" id="informacao_complementar25" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC25;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc25'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar25" id="informacao_complementar25" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC25;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc26'] == 1){ ?>
                            <input type="text" name="informacao_complementar26" id="informacao_complementar26" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC26;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc26'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar26" id="informacao_complementar26" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC26;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc27'] == 1){ ?>
                            <input type="text" name="informacao_complementar27" id="informacao_complementar27" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC27;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc22'] == 7){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar27" id="informacao_complementar27" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC27;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc28'] == 1){ ?>
                            <input type="text" name="informacao_complementar28" id="informacao_complementar28" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC28;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc28'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar28" id="informacao_complementar28" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC28;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc29'] == 1){ ?>
                            <input type="text" name="informacao_complementar29" id="informacao_complementar29" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC29;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc29'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar29" id="informacao_complementar29" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC29;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc30'] == 1){ ?>
                            <input type="text" name="informacao_complementar30" id="informacao_complementar30" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC30;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc30'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar30" id="informacao_complementar30" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC30;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc31'] == 1){ ?>
                            <input type="text" name="informacao_complementar31" id="informacao_complementar31" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC31;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc31'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar31" id="informacao_complementar31" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC31;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc32'] == 1){ ?>
                            <input type="text" name="informacao_complementar32" id="informacao_complementar32" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC32;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc32'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar32" id="informacao_complementar32" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC32;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc33'] == 1){ ?>
                            <input type="text" name="informacao_complementar33" id="informacao_complementar33" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC33;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc33'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar33" id="informacao_complementar33" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC33;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc34'] == 1){ ?>
                            <input type="text" name="informacao_complementar34" id="informacao_complementar34" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC34;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc34'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar34" id="informacao_complementar34" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC34;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc35'] == 1){ ?>
                            <input type="text" name="informacao_complementar35" id="informacao_complementar35" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC35;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc35'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar35" id="informacao_complementar35" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC35;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc36'] == 1){ ?>
                            <input type="text" name="informacao_complementar36" id="informacao_complementar36" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC36;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc36'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar36" id="informacao_complementar36" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC36;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc37'] == 1){ ?>
                            <input type="text" name="informacao_complementar37" id="informacao_complementar37" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC37;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc32'] == 7){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar37" id="informacao_complementar37" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC37;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc38'] == 1){ ?>
                            <input type="text" name="informacao_complementar38" id="informacao_complementar38" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC38;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc38'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar38" id="informacao_complementar38" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC38;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc39'] == 1){ ?>
                            <input type="text" name="informacao_complementar39" id="informacao_complementar39" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC39;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc39'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar39" id="informacao_complementar39" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC39;?></textarea>
                            <?php } ?>
                ...
                <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                    <div>
                        <?php if($GLOBALS['configVeiculosBoxIc40'] == 1){ ?>
                            <input type="text" name="informacao_complementar40" id="informacao_complementar40" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosIC40;?>" />
                        <?php } ?>
                        <?php if($GLOBALS['configVeiculosBoxIc40'] == 2){ ?>
                            <?php //Sem formatação.?>
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="informacao_complementar40" id="informacao_complementar40" class="CampoTextoMultilinha01"><?php echo $tbVeiculosIC40;?></textarea>
                            <?php } ?>
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div align="left">
                        <input type="text" name="veiculo_cep" id="veiculo_cep" class="CampoTexto02" maxlength="255"<?php if($GLOBALS['configCadastroCEPMascara'] == "1") { ?> onkeypress="javascript:mascaraGenerica('##.###-###', this, 'formVeiculosEditar', 'veiculo_cep');"<?php } ?> value="<?php echo $tbVeiculosVeiculoCEP;?>" />
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div align="left">
                        <input type="text" name="veiculo_endereco" id="veiculo_endereco" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosVeiculoEndereco;?>" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td class="TbFundoClaro">
                    <div align="left">
                        <input type="text" name="veiculo_endereco_numero" id="veiculo_endereco_numero" class="CampoTexto02" maxlength="255" value="<?php echo $tbVeiculosVeiculoEnderecoNumero;?>" />
                    </div>
                </td>
                <td class="TbFundoMedio TabelaColuna01">
                    <div align="left" class="Texto01">
                ...
                <td class="TbFundoClaro TabelaColuna01">
                    <div align="left">
                        <input type="text" name="veiculo_endereco_complemento" id="veiculo_endereco_complemento" class="CampoTexto02" maxlength="255" value="<?php echo $tbVeiculosVeiculoEnderecoComplemento;?>" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td class="TbFundoClaro">
                    <div align="left">
                        <input type="text" name="veiculo_bairro" id="veiculo_bairro" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosVeiculoBairro;?>" />
                    </div>
                </td>
                <td class="TbFundoMedio TabelaColuna01">
                    <div align="left" class="Texto01">
                ...
                <td class="TbFundoClaro TabelaColuna01">
                    <div align="left">
                        <input type="text" name="veiculo_cidade" id="veiculo_cidade" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosVeiculoCidade;?>" />
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td class="TbFundoClaro">
                    <div align="left">
                        <input type="text" name="veiculo_estado" id="veiculo_estado" class="CampoTexto02" maxlength="255" value="<?php echo $tbVeiculosVeiculoEstado;?>" />
                    </div>
                </td>
                <td class="TbFundoMedio TabelaColuna01">
                    <div align="left" class="Texto01">
                ...
                <td class="TbFundoClaro TabelaColuna01">
                    <div align="left">
                        <input type="text" name="veiculo_pais" id="veiculo_pais" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosVeiculoPais;?>" />
                    </div>
                </td>
            </tr>
            <?php } ?>
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div align="left" class="Texto01">
                        <input type="text" name="contato" id="contato" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosContato;?>" />
                    </div>
                </td>
            </tr>
            <?php } ?>
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div align="left" class="Texto01">
                        <input type="text" name="email" id="email" class="CampoTexto01" maxlength="255" value="<?php echo $tbVeiculosEmail;?>" />
                    </div>
                </td>
            </tr>
            <?php } ?>
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div align="left" class="Texto01">
                    	<textarea name="link_externo" id="link_externo" class="CampoTextoMultilinhaURL"><?php echo $tbVeiculosLinkExterno;?></textarea>
                        <br />
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div align="left" class="Texto01">
                    	<textarea name="url1" id="url1" class="CampoTextoMultilinhaURL"><?php echo $tbVeiculosURL1;?></textarea>
                        <br />
                        <?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemURL02"); ?>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div align="left" class="Texto01">
                    	<textarea name="url2" id="url2" class="CampoTextoMultilinhaURL"><?php echo $tbVeiculosURL2;?></textarea>
                        <br />
                        <?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemURL02"); ?>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div align="left" class="Texto01">
                    	<textarea name="url3" id="url3" class="CampoTextoMultilinhaURL"><?php echo $tbVeiculosURL3;?></textarea>
                        <br />
                        <?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemURL02"); ?>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div align="left" class="Texto01">
                    	<textarea name="url4" id="url4" class="CampoTextoMultilinhaURL"><?php echo $tbVeiculosURL4;?></textarea>
                        <br />
                        <?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemURL02"); ?>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div align="left" class="Texto01">
                    	<textarea name="url5" id="url5" class="CampoTextoMultilinhaURL"><?php echo $tbVeiculosURL5;?></textarea>
                        <br />
                        <?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemURL02"); ?>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div align="left" class="Texto01">
                        <textarea name="palavras_chave" id="palavras_chave" class="CampoTextoMultilinha01"><?php echo $tbVeiculosPalavrasChave;?></textarea>
                        <br />
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <input type="text" name="valor" id="valor" class="CampoNumerico02" maxlength="255" value="<?php echo $tbVeiculosValor; ?>" />
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <input type="text" name="valor1" id="valor1" class="CampoNumerico02" maxlength="255" value="<?php echo $tbVeiculosValor1; ?>" />
                        <?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemValorDescicao01"); ?>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <input type="text" name="valor2" id="valor2" class="CampoNumerico02" maxlength="255" value="<?php echo $tbVeiculosValor2; ?>" />
                        <?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemValorDescicao01"); ?>
                    </div>
                </td>
            </tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div align="left" class="Texto01">
                        <select name="ativacao_info_cadastro" id="ativacao_info_cadastro" class="CampoDropDownMenu01">
                            <option value="0"<?php if($tbVeiculosAtivacaoInfoCadastro == 0){ ?> selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemAtivacao4"); ?></option>
                            <option value="1"<?php if($tbVeiculosAtivacaoInfoCadastro == 1){ ?> selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemAtivacao5"); ?></option>
                        </select>
                    </div>
                </td>
            </tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div align="left" class="Texto01">
                        <select name="ativacao" id="ativacao" class="CampoDropDownMenu01">
                            <option value="0"<?php if($tbVeiculosAtivacao == 0){ ?> selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemAtivacao4"); ?></option>
                            <option value="1"<?php if($tbVeiculosAtivacao == 1){ ?> selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemAtivacao5"); ?></option>
                        </select>
                    </div>
                </td>
            </tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div class="Texto01">
                        ...
                        <select name="id_tb_veiculos_status" id="id_tb_veiculos_status" class="CampoDropDownMenu01">
                            <option value="0"<?php if($tbVeiculosIdTbVeiculosStatus == 0){ ?> selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemFiltroGenerico03"); ?></option>
                            <?php 
                    ...
                    <div>
                        <table cellpadding="0" cellspacing="0" style="width: 100%;">
                            <tr>
                                ...
                                <td>
                                    <a href="RegistrosArquivosExcluirExe.php?idRegistro=<?php echo $tbVeiculosId;?>&strTabela=tb_veiculos&strCampo=imagem<?php echo $queryPadrao;?>" class="LinksExcluir01" style="margin-left: 4px;">
            ...
            <tr>
                ...
                <td class="TbFundoClaro" colspan="3">
                    <div align="left">
                        <textarea name="anotacoes_internas" id="anotacoes_internas" class="CampoTextoMultilinha01"><?php echo $tbVeiculosAnotacoesInternas;?></textarea>
                    </div>
                </td>
            </tr>
        ...
        <div>
            <div style="float:left;">
                <input type="image" id="btnVeiculosEditar" name="submit" value="Submit" src="img/btoAtualizar.png" alt="<?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaBotaoAtualizar"); ?>" />
