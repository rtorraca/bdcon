...
if (empty($resultadoHistoricoDetalhes))
{
	...
	foreach($resultadoHistoricoDetalhes as $linhaHistoricoDetalhes)
	{
		...
		if($linhaHistoricoDetalhes['data1'] == NULL)
		{
			...
			$tbHistoricoData1 = Funcoes::DataLeitura01($linhaHistoricoDetalhes['data1'], $GLOBALS['configSistemaFormatoData'], "1");
		}
		if($linhaHistoricoDetalhes['data2'] == NULL)
		{
			$tbHistoricoData2 = "";
		}else{
			$tbHistoricoData2 = Funcoes::DataLeitura01($linhaHistoricoDetalhes['data2'], $GLOBALS['configSistemaFormatoData'], "1");
		}
		if($linhaHistoricoDetalhes['data3'] == NULL)
		{
			$tbHistoricoData3 = "";
		}else{
			$tbHistoricoData3 = Funcoes::DataLeitura01($linhaHistoricoDetalhes['data3'], $GLOBALS['configSistemaFormatoData'], "1");
		}
		if($linhaHistoricoDetalhes['data4'] == NULL)
		{
			$tbHistoricoData4 = "";
		}else{
			$tbHistoricoData4 = Funcoes::DataLeitura01($linhaHistoricoDetalhes['data4'], $GLOBALS['configSistemaFormatoData'], "1");
		}
		if($linhaHistoricoDetalhes['data5'] == NULL)
		{
			$tbHistoricoData5 = "";
		}else{
			$tbHistoricoData5 = Funcoes::DataLeitura01($linhaHistoricoDetalhes['data5'], $GLOBALS['configSistemaFormatoData'], "1");
		}
...
<?php ob_start(); /* cphTitle*/ ?>
	...
	<?php echo Funcoes::ConteudoMascaraLeitura($GLOBALS['configNomeCliente'], "IncludeConfig"); ?>
     - 
	<?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaHistoricoEditarTitulo"); ?>
<?php 
...
<?php ob_start(); /*cphConteudoPrincipal*/ ?>
    ...
    <form name="formHistoricoEditar" id="formHistoricoEditar" action="HistoricoEditarExe.php" method="post" enctype="multipart/form-data" class="FormularioDados01">
        <div>
            <table class="TabelaCampos01">
                <tr>
                    <td class="TbFundoEscuro" colspan="4">
                        <div align="center" class="Texto02">
                            <strong>
                                <?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaHistoricoTbHistoricoEditar"); ?>
                            </strong>
                        </div>
                    </td>
                </tr>
                        ...
                        <div align="left" class="Texto01">
							...
							<?php if($configCadastroHistoricoDataEdicao == 1) { ?>
                                ...
                                <?php if($GLOBALS['configDataTipoCampo'] == 1){ ?>
                                    ...
                                    <input type="text" name="data_historico" id="data_historico" class="CampoData01" maxlength="10" value="<?php echo $tbHistoricoDataHistorico; ?>" />
                        ...
                        <div align="left">
                            ...
                            <?php if($GLOBALS['configTipoCampoHistoricoData1'] == 1){ ?>
                                <?php if($GLOBALS['configDataTipoCampo'] == 1){ ?>
                                    ...
                                    <input type="text" name="data1" id="data1" class="CampoData01" maxlength="10" value="<?php echo $tbHistoricoData1; ?>" />
                                    <?php //echo Funcoes::DataGravacaoSql("15/02/1980", 1); ?>
                                <?php } ?>
                            <?php } ?>
                            <?php //---------------------- ?>
                        ...
                        <div align="left">
                            ...
                            <?php if($GLOBALS['configTipoCampoHistoricoData2'] == 1){ ?>
                                <?php if($GLOBALS['configDataTipoCampo'] == 1){ ?>
                                    ...
                                    <input type="text" name="data2" id="data2" class="CampoData01" maxlength="10" value="<?php echo $tbHistoricoData2; ?>" />
                                    <?php //echo Funcoes::DataGravacaoSql("15/02/1980", 1); ?>
                                <?php } ?>
                            <?php } ?>
                            <?php //---------------------- ?>
                        ...
                        <div align="left">
                            ...
                            <?php if($GLOBALS['configTipoCampoHistoricoData3'] == 1){ ?>
                                <?php if($GLOBALS['configDataTipoCampo'] == 1){ ?>
                                    ...
                                    <input type="text" name="data3" id="data3" class="CampoData01" maxlength="10" value="<?php echo $tbHistoricoData3; ?>" />
                                    <?php //echo Funcoes::DataGravacaoSql("15/02/1980", 1); ?>
                                <?php } ?>
                            <?php } ?>
                            <?php //---------------------- ?>
                        ...
                        <div align="left">
                            ...
                            <?php if($GLOBALS['configTipoCampoHistoricoData4'] == 1){ ?>
                                <?php if($GLOBALS['configDataTipoCampo'] == 1){ ?>
                                    ...
                                    <input type="text" name="data4" id="data4" class="CampoData01" maxlength="10" value="<?php echo $tbHistoricoData4; ?>" />
                                    <?php //echo Funcoes::DataGravacaoSql("15/02/1980", 1); ?>
                                <?php } ?>
                            <?php } ?>
                            <?php //---------------------- ?>
                        ...
                        <div align="left">
                            ...
                            <?php if($GLOBALS['configTipoCampoHistoricoData5'] == 1){ ?>
                                <?php if($GLOBALS['configDataTipoCampo'] == 1){ ?>
                                    ...
                                    <input type="text" name="data5" id="data5" class="CampoData01" maxlength="10" value="<?php echo $tbHistoricoData5; ?>" />
                                    <?php //echo Funcoes::DataGravacaoSql("15/02/1980", 1); ?>
                                <?php } ?>
                            <?php } ?>
                            <?php //---------------------- ?>
                ...
                <tr>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div align="left">
                            <input type="text" name="assunto" id="assunto" class="CampoTexto01" value="<?php echo $tbHistoricoAssunto; ?>" />
                        </div>
                    </td>
                </tr>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div>
                            ...
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                <textarea name="historico" id="historico" class="CampoTextoMultilinha01"><?php echo $tbHistoricoHistorico; ?></textarea>
                            <?php } ?>
                            ...
                            <?php if($GLOBALS['configConteudoCaixaTexto'] == 11){ ?>
                                ...
                                <textarea name="historico" id="historico"><?php echo $tbHistoricoHistorico; ?></textarea>
                            <?php } ?>
                ...
                <tr>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            //echo "FiltrosGenericosSelect03=" . FiltrosGenericosSelect03($tbHistoricoId, "tb_historico_relacao_complemento", "id_tb_historico", "id_tb_historico_complemento", "12", "", ",", "", "1") . "<br />";
                            //echo "FiltrosGenericosSelect03=" . DbFuncoes::FiltrosGenericosSelect03($tbHistoricoId, "tb_historico_relacao_complemento", "id_tb_historico", "id_tb_historico_complemento", "12", "", ",", "", "1") . "<br />";
                            ...
                            $arrHistoricoFiltroGenerico01Selecao = explode(",", DbFuncoes::FiltrosGenericosSelect03($tbHistoricoId, "tb_historico_relacao_complemento", "id_tb_historico", "id_tb_historico_complemento", "12", "", ",", "", "1"));
                            //echo "arrHistoricoFiltroGenerico01Selecao=" . $arrHistoricoFiltroGenerico01Selecao[0] . "<br />";
                            //echo "in_array=" . in_array("03", $arrHistoricoFiltroGenerico01Selecao) . "<br />";
                        
                            //echo "arrHistoricoFiltroGenerico01Selecao=" . $arrHistoricoFiltroGenerico01Selecao . "<br />";
                            //echo "arrHistoricoFiltroGenerico01Selecao[0]=" . $arrHistoricoFiltroGenerico01Selecao[0] . "<br />";
                            ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico01CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico01[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico01[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico01[$countArray][0], $arrHistoricoFiltroGenerico01Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico01[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico01CaixaSelecao'] == 2){ ?>
                                <select id="idsHistoricoFiltroGenerico01[]" name="idsHistoricoFiltroGenerico01[]" size="5" multiple="multiple" class="CampoFiltroGenericoListBox01">
                                    ...
                                    {
                                    ?>
                                        <option value="<?php echo $arrHistoricoFiltroGenerico01[$countArray][0];?>"<?php if(in_array($arrHistoricoFiltroGenerico01[$countArray][0], $arrHistoricoFiltroGenerico01Selecao)){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoFiltroGenerico01[$countArray][1];?></option>
                                    <?php 
                                    }
                                    ?>
                                </select> 
                ...
                <tr>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            <?php
                            //Seleção de ids selecionados para o registro.
                            $arrHistoricoFiltroGenerico02Selecao = explode(",", DbFuncoes::FiltrosGenericosSelect03($tbHistoricoId, "tb_historico_relacao_complemento", "id_tb_historico", "id_tb_historico_complemento", "13", "", ",", "", "1"));
                            ?>
                        
                            <?php 
                            $arrHistoricoFiltroGenerico02 = DbFuncoes::FiltrosGenericosFill01("tb_historico_complemento", 13);
                            //echo "arrHistoricoFiltroGenerico02Selecao=" . $arrHistoricoFiltroGenerico02Selecao . "<br />";
                            //echo "arrHistoricoFiltroGenerico02Selecao[0]=" . $arrHistoricoFiltroGenerico02Selecao[0] . "<br />";
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico02CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico02[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico02[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico02[$countArray][0], $arrHistoricoFiltroGenerico02Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico02[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico02CaixaSelecao'] == 2){ ?>
                                <select id="idsHistoricoFiltroGenerico02[]" name="idsHistoricoFiltroGenerico02[]" size="5" multiple="multiple" class="CampoFiltroGenericoListBox01">
                                    ...
                                    {
                                    ?>
                                        <option value="<?php echo $arrHistoricoFiltroGenerico02[$countArray][0];?>"<?php if(in_array($arrHistoricoFiltroGenerico02[$countArray][0], $arrHistoricoFiltroGenerico02Selecao)){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoFiltroGenerico02[$countArray][1];?></option>
                                    <?php 
                                    }
                                    ?>
                                </select> 
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico03CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico03[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico03[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico03[$countArray][0], $arrHistoricoFiltroGenerico03Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico03[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico04CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico04[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico04[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico04[$countArray][0], $arrHistoricoFiltroGenerico04Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico04[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico05CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico05[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico05[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico05[$countArray][0], $arrHistoricoFiltroGenerico05Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico05[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico06CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico06[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico06[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico06[$countArray][0], $arrHistoricoFiltroGenerico06Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico06[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico07CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico07[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico07[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico07[$countArray][0], $arrHistoricoFiltroGenerico07Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico07[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico08CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico08[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico08[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico08[$countArray][0], $arrHistoricoFiltroGenerico08Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico08[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico09CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico09[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico09[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico09[$countArray][0], $arrHistoricoFiltroGenerico09Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico09[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico10CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico10[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico10[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico10[$countArray][0], $arrHistoricoFiltroGenerico10Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico10[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico11CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico11[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico11[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico11[$countArray][0], $arrHistoricoFiltroGenerico11Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico11[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico12CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico12[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico12[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico12[$countArray][0], $arrHistoricoFiltroGenerico12Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico12[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico13CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico13[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico13[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico13[$countArray][0], $arrHistoricoFiltroGenerico13Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico13[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico14CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico14[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico14[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico14[$countArray][0], $arrHistoricoFiltroGenerico14Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico14[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico15CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico15[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico15[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico15[$countArray][0], $arrHistoricoFiltroGenerico15Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico15[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico16CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico16[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico16[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico16[$countArray][0], $arrHistoricoFiltroGenerico16Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico16[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico17CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico17[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico17[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico17[$countArray][0], $arrHistoricoFiltroGenerico17Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico17[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico18CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico18[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico18[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico18[$countArray][0], $arrHistoricoFiltroGenerico18Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico18[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico19CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico19[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico19[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico19[$countArray][0], $arrHistoricoFiltroGenerico19Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico19[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico20CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico20[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico20[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico20[$countArray][0], $arrHistoricoFiltroGenerico20Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico20[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico21CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico21[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico21[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico21[$countArray][0], $arrHistoricoFiltroGenerico21Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico21[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico22CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico22[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico22[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico22[$countArray][0], $arrHistoricoFiltroGenerico22Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico22[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico23CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico23[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico23[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico23[$countArray][0], $arrHistoricoFiltroGenerico23Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico23[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico24CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico24[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico24[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico24[$countArray][0], $arrHistoricoFiltroGenerico24Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico24[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico25CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico25[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico25[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico25[$countArray][0], $arrHistoricoFiltroGenerico25Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico25[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico26CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico26[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico26[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico26[$countArray][0], $arrHistoricoFiltroGenerico26Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico26[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico27CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico27[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico27[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico27[$countArray][0], $arrHistoricoFiltroGenerico27Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico27[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico28CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico28[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico28[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico28[$countArray][0], $arrHistoricoFiltroGenerico28Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico28[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico29CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico29[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico29[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico29[$countArray][0], $arrHistoricoFiltroGenerico29Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico29[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico30CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico30[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico30[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico30[$countArray][0], $arrHistoricoFiltroGenerico30Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico30[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico31CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico31[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico31[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico31[$countArray][0], $arrHistoricoFiltroGenerico31Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico31[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico32CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico32[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico32[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico32[$countArray][0], $arrHistoricoFiltroGenerico32Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico32[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico33CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico33[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico33[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico33[$countArray][0], $arrHistoricoFiltroGenerico33Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico33[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico34CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico34[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico34[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico34[$countArray][0], $arrHistoricoFiltroGenerico34Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico34[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico35CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico35[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico35[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico35[$countArray][0], $arrHistoricoFiltroGenerico35Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico35[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico36CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico36[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico36[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico36[$countArray][0], $arrHistoricoFiltroGenerico36Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico36[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico37CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico37[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico37[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico37[$countArray][0], $arrHistoricoFiltroGenerico37Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico37[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico38CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico38[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico38[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico38[$countArray][0], $arrHistoricoFiltroGenerico38Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico38[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico39CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico39[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico39[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico39[$countArray][0], $arrHistoricoFiltroGenerico39Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico39[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico40CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico40[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico40[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico40[$countArray][0], $arrHistoricoFiltroGenerico40Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico40[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico41CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico41[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico41[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico41[$countArray][0], $arrHistoricoFiltroGenerico41Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico41[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico42CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico42[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico42[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico42[$countArray][0], $arrHistoricoFiltroGenerico42Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico42[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico43CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico43[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico43[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico43[$countArray][0], $arrHistoricoFiltroGenerico43Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico43[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico44CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico44[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico44[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico44[$countArray][0], $arrHistoricoFiltroGenerico44Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico44[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico45CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico45[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico45[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico45[$countArray][0], $arrHistoricoFiltroGenerico45Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico45[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico46CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico46[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico46[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico46[$countArray][0], $arrHistoricoFiltroGenerico46Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico46[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico47CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico47[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico47[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico47[$countArray][0], $arrHistoricoFiltroGenerico47Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico47[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico48CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico48[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico48[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico48[$countArray][0], $arrHistoricoFiltroGenerico48Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico48[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico49CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico49[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico49[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico49[$countArray][0], $arrHistoricoFiltroGenerico49Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico49[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico50CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico50[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico50[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico50[$countArray][0], $arrHistoricoFiltroGenerico50Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico50[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico51CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico51[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico51[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico51[$countArray][0], $arrHistoricoFiltroGenerico51Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico51[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico52CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico52[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico52[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico52[$countArray][0], $arrHistoricoFiltroGenerico52Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico52[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico53CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico53[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico53[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico53[$countArray][0], $arrHistoricoFiltroGenerico53Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico53[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico54CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico54[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico54[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico54[$countArray][0], $arrHistoricoFiltroGenerico54Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico54[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico55CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico55[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico55[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico55[$countArray][0], $arrHistoricoFiltroGenerico55Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico55[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                ...
                <tr>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            <?php
                            //Seleção de ids selecionados para o registro.
                            $arrHistoricoFiltroGenerico56Selecao = explode(",", DbFuncoes::FiltrosGenericosSelect03($tbHistoricoId, "tb_historico_relacao_complemento", "id_tb_historico", "id_tb_historico_complemento", "67", "", ",", "", "1"));
                            ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico56CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico56[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico56[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico56[$countArray][0], $arrHistoricoFiltroGenerico56Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico56[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico56CaixaSelecao'] == 2){ ?>
                                <select id="idsHistoricoFiltroGenerico56[]" name="idsHistoricoFiltroGenerico56[]" size="5" multiple="multiple" class="CampoFiltroGenericoListBox01">
                                    ...
                                    {
                                    ?>
                                        <option value="<?php echo $arrHistoricoFiltroGenerico56[$countArray][0];?>"<?php if(in_array($arrHistoricoFiltroGenerico56[$countArray][0], $arrHistoricoFiltroGenerico56Selecao)){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoFiltroGenerico56[$countArray][1];?></option>
                                    <?php 
                                    }
                                    ?>
                                </select> 
                ...
                <tr>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            <?php
                            //Seleção de ids selecionados para o registro.
                            $arrHistoricoFiltroGenerico57Selecao = explode(",", DbFuncoes::FiltrosGenericosSelect03($tbHistoricoId, "tb_historico_relacao_complemento", "id_tb_historico", "id_tb_historico_complemento", "68", "", ",", "", "1"));
                            ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico57CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico57[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico57[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico57[$countArray][0], $arrHistoricoFiltroGenerico57Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico57[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico57CaixaSelecao'] == 2){ ?>
                                <select id="idsHistoricoFiltroGenerico57[]" name="idsHistoricoFiltroGenerico57[]" size="5" multiple="multiple" class="CampoFiltroGenericoListBox01">
                                    ...
                                    {
                                    ?>
                                        <option value="<?php echo $arrHistoricoFiltroGenerico57[$countArray][0];?>"<?php if(in_array($arrHistoricoFiltroGenerico57[$countArray][0], $arrHistoricoFiltroGenerico57Selecao)){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoFiltroGenerico57[$countArray][1];?></option>
                                    <?php 
                                    }
                                    ?>
                                </select> 
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico58CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico58[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico58[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico58[$countArray][0], $arrHistoricoFiltroGenerico58Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico58[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico59CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico59[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico59[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico59[$countArray][0], $arrHistoricoFiltroGenerico59Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico59[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico60CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico60[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico60[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico60[$countArray][0], $arrHistoricoFiltroGenerico60Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico60[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico61CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico61[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico61[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico61[$countArray][0], $arrHistoricoFiltroGenerico61Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico61[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico62CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico62[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico62[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico62[$countArray][0], $arrHistoricoFiltroGenerico62Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico62[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico63CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico63[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico63[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico63[$countArray][0], $arrHistoricoFiltroGenerico63Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico63[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico64CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico64[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico64[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico64[$countArray][0], $arrHistoricoFiltroGenerico64Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico64[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico65CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico65[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico65[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico65[$countArray][0], $arrHistoricoFiltroGenerico65Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico65[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico66CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico66[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico66[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico66[$countArray][0], $arrHistoricoFiltroGenerico66Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico66[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico67CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico67[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico67[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico67[$countArray][0], $arrHistoricoFiltroGenerico67Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico67[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico68CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico68[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico68[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico68[$countArray][0], $arrHistoricoFiltroGenerico68Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico68[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico69CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico69[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico69[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico69[$countArray][0], $arrHistoricoFiltroGenerico69Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico69[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico70CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico70[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico70[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico70[$countArray][0], $arrHistoricoFiltroGenerico70Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico70[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico71CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico71[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico71[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico71[$countArray][0], $arrHistoricoFiltroGenerico71Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico71[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico72CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico72[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico72[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico72[$countArray][0], $arrHistoricoFiltroGenerico72Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico72[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico73CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico73[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico73[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico73[$countArray][0], $arrHistoricoFiltroGenerico73Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico73[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                ...
                <tr>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            <?php
                            //Seleção de ids selecionados para o registro.
                            $arrHistoricoFiltroGenerico74Selecao = explode(",", DbFuncoes::FiltrosGenericosSelect03($tbHistoricoId, "tb_historico_relacao_complemento", "id_tb_historico", "id_tb_historico_complemento", "85", "", ",", "", "1"));
                            ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico74CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico74[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico74[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico74[$countArray][0], $arrHistoricoFiltroGenerico74Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico74[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico74CaixaSelecao'] == 2){ ?>
                                <select id="idsHistoricoFiltroGenerico74[]" name="idsHistoricoFiltroGenerico74[]" size="5" multiple="multiple" class="CampoFiltroGenericoListBox01">
                                    ...
                                    {
                                    ?>
                                        <option value="<?php echo $arrHistoricoFiltroGenerico74[$countArray][0];?>"<?php if(in_array($arrHistoricoFiltroGenerico74[$countArray][0], $arrHistoricoFiltroGenerico74Selecao)){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoFiltroGenerico74[$countArray][1];?></option>
                                    <?php 
                                    }
                                    ?>
                                </select> 
                ...
                <tr>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            <?php
                            //Seleção de ids selecionados para o registro.
                            $arrHistoricoFiltroGenerico75Selecao = explode(",", DbFuncoes::FiltrosGenericosSelect03($tbHistoricoId, "tb_historico_relacao_complemento", "id_tb_historico", "id_tb_historico_complemento", "86", "", ",", "", "1"));
                            ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico75CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico75[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico75[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico75[$countArray][0], $arrHistoricoFiltroGenerico75Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico75[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico75CaixaSelecao'] == 2){ ?>
                                <select id="idsHistoricoFiltroGenerico75[]" name="idsHistoricoFiltroGenerico75[]" size="5" multiple="multiple" class="CampoFiltroGenericoListBox01">
                                    ...
                                    {
                                    ?>
                                        <option value="<?php echo $arrHistoricoFiltroGenerico75[$countArray][0];?>"<?php if(in_array($arrHistoricoFiltroGenerico75[$countArray][0], $arrHistoricoFiltroGenerico75Selecao)){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoFiltroGenerico75[$countArray][1];?></option>
                                    <?php 
                                    }
                                    ?>
                                </select> 
                ...
                <tr>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            <?php
                            //Seleção de ids selecionados para o registro.
                            $arrHistoricoFiltroGenerico76Selecao = explode(",", DbFuncoes::FiltrosGenericosSelect03($tbHistoricoId, "tb_historico_relacao_complemento", "id_tb_historico", "id_tb_historico_complemento", "87", "", ",", "", "1"));
                            ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico76CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico76[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico76[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico76[$countArray][0], $arrHistoricoFiltroGenerico76Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico76[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico76CaixaSelecao'] == 2){ ?>
                                <select id="idsHistoricoFiltroGenerico76[]" name="idsHistoricoFiltroGenerico76[]" size="5" multiple="multiple" class="CampoFiltroGenericoListBox01">
                                    ...
                                    {
                                    ?>
                                        <option value="<?php echo $arrHistoricoFiltroGenerico76[$countArray][0];?>"<?php if(in_array($arrHistoricoFiltroGenerico76[$countArray][0], $arrHistoricoFiltroGenerico76Selecao)){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoFiltroGenerico76[$countArray][1];?></option>
                                    <?php 
                                    }
                                    ?>
                                </select> 
                ...
                <tr>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            <?php
                            //Seleção de ids selecionados para o registro.
                            $arrHistoricoFiltroGenerico77Selecao = explode(",", DbFuncoes::FiltrosGenericosSelect03($tbHistoricoId, "tb_historico_relacao_complemento", "id_tb_historico", "id_tb_historico_complemento", "88", "", ",", "", "1"));
                            ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico77CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico77[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico77[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico77[$countArray][0], $arrHistoricoFiltroGenerico77Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico77[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico77CaixaSelecao'] == 2){ ?>
                                <select id="idsHistoricoFiltroGenerico77[]" name="idsHistoricoFiltroGenerico77[]" size="5" multiple="multiple" class="CampoFiltroGenericoListBox01">
                                    ...
                                    {
                                    ?>
                                        <option value="<?php echo $arrHistoricoFiltroGenerico77[$countArray][0];?>"<?php if(in_array($arrHistoricoFiltroGenerico77[$countArray][0], $arrHistoricoFiltroGenerico77Selecao)){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoFiltroGenerico77[$countArray][1];?></option>
                                    <?php 
                                    }
                                    ?>
                                </select> 
                ...
                <tr>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            <?php
                            //Seleção de ids selecionados para o registro.
                            $arrHistoricoFiltroGenerico78Selecao = explode(",", DbFuncoes::FiltrosGenericosSelect03($tbHistoricoId, "tb_historico_relacao_complemento", "id_tb_historico", "id_tb_historico_complemento", "89", "", ",", "", "1"));
                            ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico78CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico78[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico78[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico78[$countArray][0], $arrHistoricoFiltroGenerico78Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico78[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico78CaixaSelecao'] == 2){ ?>
                                <select id="idsHistoricoFiltroGenerico78[]" name="idsHistoricoFiltroGenerico78[]" size="5" multiple="multiple" class="CampoFiltroGenericoListBox01">
                                    ...
                                    {
                                    ?>
                                        <option value="<?php echo $arrHistoricoFiltroGenerico78[$countArray][0];?>"<?php if(in_array($arrHistoricoFiltroGenerico78[$countArray][0], $arrHistoricoFiltroGenerico78Selecao)){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoFiltroGenerico78[$countArray][1];?></option>
                                    <?php 
                                    }
                                    ?>
                                </select> 
                ...
                <tr>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            <?php
                            //Seleção de ids selecionados para o registro.
                            $arrHistoricoFiltroGenerico79Selecao = explode(",", DbFuncoes::FiltrosGenericosSelect03($tbHistoricoId, "tb_historico_relacao_complemento", "id_tb_historico", "id_tb_historico_complemento", "90", "", ",", "", "1"));
                            ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico79CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico79[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico79[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico79[$countArray][0], $arrHistoricoFiltroGenerico79Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico79[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico79CaixaSelecao'] == 2){ ?>
                                <select id="idsHistoricoFiltroGenerico79[]" name="idsHistoricoFiltroGenerico79[]" size="5" multiple="multiple" class="CampoFiltroGenericoListBox01">
                                    ...
                                    {
                                    ?>
                                        <option value="<?php echo $arrHistoricoFiltroGenerico79[$countArray][0];?>"<?php if(in_array($arrHistoricoFiltroGenerico79[$countArray][0], $arrHistoricoFiltroGenerico79Selecao)){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoFiltroGenerico79[$countArray][1];?></option>
                                    <?php 
                                    }
                                    ?>
                                </select> 
                ...
                <tr>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            <?php
                            //Seleção de ids selecionados para o registro.
                            $arrHistoricoFiltroGenerico80Selecao = explode(",", DbFuncoes::FiltrosGenericosSelect03($tbHistoricoId, "tb_historico_relacao_complemento", "id_tb_historico", "id_tb_historico_complemento", "91", "", ",", "", "1"));
                            ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico80CaixaSelecao'] == 1){ ?>
                                ...
                                ?>
                                    <div>
                                        <input name="idsHistoricoFiltroGenerico80[]" type="checkbox" value="<?php echo $arrHistoricoFiltroGenerico80[$countArray][0];?>" class="CampoCheckBox01"<?php if(in_array($arrHistoricoFiltroGenerico80[$countArray][0], $arrHistoricoFiltroGenerico80Selecao)){ ?> checked="checked"<?php } ?> /> <?php echo $arrHistoricoFiltroGenerico80[$countArray][1];?>
                                    </div>
                                <?php 
                                }
                                ?>
                            ...
                            <?php if($GLOBALS['configHistoricoFiltroGenerico80CaixaSelecao'] == 2){ ?>
                                <select id="idsHistoricoFiltroGenerico80[]" name="idsHistoricoFiltroGenerico80[]" size="5" multiple="multiple" class="CampoFiltroGenericoListBox01">
                                    ...
                                    {
                                    ?>
                                        <option value="<?php echo $arrHistoricoFiltroGenerico80[$countArray][0];?>"<?php if(in_array($arrHistoricoFiltroGenerico80[$countArray][0], $arrHistoricoFiltroGenerico80Selecao)){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoFiltroGenerico80[$countArray][1];?></option>
                                    <?php 
                                    }
                                    ?>
                                </select> 
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <select name="id_tb_cadastro5" id="id_tb_cadastro5" class="CampoDropDownMenu01">
                                <option value="0"<?php if($tbHistoricoIdTbCadastro5 == 0){ ?>selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemNenhumDropDown"); ?></option>
                                <?php 
                                for($countArray = 0; $countArray < count($arrHistoricoVinculo5); $countArray++)
                                {
                                ?>
                                    <option value="<?php echo $arrHistoricoVinculo5[$countArray][0];?>"<?php if($arrHistoricoVinculo5[$countArray][0] == $tbHistoricoIdTbCadastro5){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoVinculo5[$countArray][1];?></option>
                                <?php 
                                }
                                ?>
                            </select>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <select name="id_tb_cadastro6" id="id_tb_cadastro6" class="CampoDropDownMenu01">
                                <option value="0"<?php if($tbHistoricoIdTbCadastro6 == 0){ ?>selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemNenhumDropDown"); ?></option>
                                <?php 
                                for($countArray = 0; $countArray < count($arrHistoricoVinculo6); $countArray++)
                                {
                                ?>
                                    <option value="<?php echo $arrHistoricoVinculo6[$countArray][0];?>"<?php if($arrHistoricoVinculo6[$countArray][0] == $tbHistoricoIdTbCadastro6){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoVinculo6[$countArray][1];?></option>
                                <?php 
                                }
                                ?>
                            </select>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <select name="id_tb_cadastro7" id="id_tb_cadastro7" class="CampoDropDownMenu01">
                                <option value="0"<?php if($tbHistoricoIdTbCadastro7 == 0){ ?>selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemNenhumDropDown"); ?></option>
                                <?php 
                                for($countArray = 0; $countArray < count($arrHistoricoVinculo7); $countArray++)
                                {
                                ?>
                                    <option value="<?php echo $arrHistoricoVinculo7[$countArray][0];?>"<?php if($arrHistoricoVinculo7[$countArray][0] == $tbHistoricoIdTbCadastro7){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoVinculo7[$countArray][1];?></option>
                                <?php 
                                }
                                ?>
                            </select>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <select name="id_tb_cadastro8" id="id_tb_cadastro8" class="CampoDropDownMenu01">
                                <option value="0"<?php if($tbHistoricoIdTbCadastro8 == 0){ ?>selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemNenhumDropDown"); ?></option>
                                <?php 
                                for($countArray = 0; $countArray < count($arrHistoricoVinculo8); $countArray++)
                                {
                                ?>
                                    <option value="<?php echo $arrHistoricoVinculo8[$countArray][0];?>"<?php if($arrHistoricoVinculo8[$countArray][0] == $tbHistoricoIdTbCadastro8){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoVinculo8[$countArray][1];?></option>
                                <?php 
                                }
                                ?>
                            </select>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <select name="id_tb_cadastro9" id="id_tb_cadastro9" class="CampoDropDownMenu01">
                                <option value="0"<?php if($tbHistoricoIdTbCadastro9 == 0){ ?>selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemNenhumDropDown"); ?></option>
                                <?php 
                                for($countArray = 0; $countArray < count($arrHistoricoVinculo9); $countArray++)
                                {
                                ?>
                                    <option value="<?php echo $arrHistoricoVinculo9[$countArray][0];?>"<?php if($arrHistoricoVinculo9[$countArray][0] == $tbHistoricoIdTbCadastro9){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoVinculo9[$countArray][1];?></option>
                                <?php 
                                }
                                ?>
                            </select>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <select name="id_tb_cadastro10" id="id_tb_cadastro10" class="CampoDropDownMenu01">
                                <option value="0"<?php if($tbHistoricoIdTbCadastro10 == 0){ ?>selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemNenhumDropDown"); ?></option>
                                <?php 
                                for($countArray = 0; $countArray < count($arrHistoricoVinculo10); $countArray++)
                                {
                                ?>
                                    <option value="<?php echo $arrHistoricoVinculo10[$countArray][0];?>"<?php if($arrHistoricoVinculo10[$countArray][0] == $tbHistoricoIdTbCadastro10){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoVinculo10[$countArray][1];?></option>
                                <?php 
                                }
                                ?>
                            </select>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc1'] == 1){ ?>
                                <input type="text" name="informacao_complementar1" id="informacao_complementar1" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC1;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc1'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar1" id="informacao_complementar1" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC1;?></textarea>
                                <?php } ?>
                                ...
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 11){ ?>
                                    ...
                                    <textarea name="informacao_complementar1" id="informacao_complementar1"><?php echo $tbHistoricoIC1;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc2'] == 1){ ?>
                                <input type="text" name="informacao_complementar2" id="informacao_complementar2" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC2;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc2'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar2" id="informacao_complementar2" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC2;?></textarea>
                                <?php } ?>
                                ...
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 11){ ?>
                                    ...
                                    <textarea name="informacao_complementar2" id="informacao_complementar2"><?php echo $tbHistoricoIC2;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc3'] == 1){ ?>
                                <input type="text" name="informacao_complementar3" id="informacao_complementar3" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC3;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc3'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar3" id="informacao_complementar3" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC3;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc4'] == 1){ ?>
                                <input type="text" name="informacao_complementar4" id="informacao_complementar4" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC4;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc4'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar4" id="informacao_complementar4" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC4;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc5'] == 1){ ?>
                                <input type="text" name="informacao_complementar5" id="informacao_complementar5" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC5;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc5'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar5" id="informacao_complementar5" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC5;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc6'] == 1){ ?>
                                <input type="text" name="informacao_complementar6" id="informacao_complementar6" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC6;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc6'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar6" id="informacao_complementar6" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC6;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc7'] == 1){ ?>
                                <input type="text" name="informacao_complementar7" id="informacao_complementar7" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC7;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc7'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar7" id="informacao_complementar7" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC7;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc8'] == 1){ ?>
                                <input type="text" name="informacao_complementar8" id="informacao_complementar8" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC8;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc8'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar8" id="informacao_complementar8" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC8;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc9'] == 1){ ?>
                                <input type="text" name="informacao_complementar9" id="informacao_complementar9" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC9;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc9'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar9" id="informacao_complementar9" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC9;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc10'] == 1){ ?>
                                <input type="text" name="informacao_complementar10" id="informacao_complementar10" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC10;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc10'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar10" id="informacao_complementar10" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC10;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc11'] == 1){ ?>
                                <input type="text" name="informacao_complementar11" id="informacao_complementar11" class="CampoTexto01" maxlength="255"  value="<?php echo $tbHistoricoIC11;?>"/>
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc11'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar11" id="informacao_complementar11" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC11;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc12'] == 1){ ?>
                                <input type="text" name="informacao_complementar12" id="informacao_complementar12" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC12;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc12'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar12" id="informacao_complementar12" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC12;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc13'] == 1){ ?>
                                <input type="text" name="informacao_complementar13" id="informacao_complementar13" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC13;?>">
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc13'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar13" id="informacao_complementar13" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC13;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc14'] == 1){ ?>
                                <input type="text" name="informacao_complementar14" id="informacao_complementar14" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC14;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc14'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar14" id="informacao_complementar14" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC14;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc15'] == 1){ ?>
                                <input type="text" name="informacao_complementar15" id="informacao_complementar15" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC15;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc15'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar15" id="informacao_complementar15" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC15;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc16'] == 1){ ?>
                                <input type="text" name="informacao_complementar16" id="informacao_complementar16" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC16;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc16'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar16" id="informacao_complementar16" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC16;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc17'] == 1){ ?>
                                <input type="text" name="informacao_complementar17" id="informacao_complementar17" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC17;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc17'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar17" id="informacao_complementar17" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC17;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc18'] == 1){ ?>
                                <input type="text" name="informacao_complementar18" id="informacao_complementar18" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC18;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc18'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar18" id="informacao_complementar18" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC18;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc19'] == 1){ ?>
                                <input type="text" name="informacao_complementar19" id="informacao_complementar19" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC19;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc19'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar19" id="informacao_complementar19" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC19;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc20'] == 1){ ?>
                                <input type="text" name="informacao_complementar20" id="informacao_complementar20" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC20;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc20'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar20" id="informacao_complementar20" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC20;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc21'] == 1){ ?>
                                <input type="text" name="informacao_complementar21" id="informacao_complementar21" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC21;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc21'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar21" id="informacao_complementar21" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC21;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc22'] == 1){ ?>
                                <input type="text" name="informacao_complementar22" id="informacao_complementar22" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC22;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc22'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar22" id="informacao_complementar22" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC22;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc23'] == 1){ ?>
                                <input type="text" name="informacao_complementar23" id="informacao_complementar23" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC23;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc23'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar23" id="informacao_complementar23" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC23;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc24'] == 1){ ?>
                                <input type="text" name="informacao_complementar24" id="informacao_complementar24" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC24;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc24'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar24" id="informacao_complementar24" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC24;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc25'] == 1){ ?>
                                <input type="text" name="informacao_complementar25" id="informacao_complementar25" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC25;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc25'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar25" id="informacao_complementar25" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC25;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc26'] == 1){ ?>
                                <input type="text" name="informacao_complementar26" id="informacao_complementar26" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC26;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc26'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar26" id="informacao_complementar26" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC26;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc27'] == 1){ ?>
                                <input type="text" name="informacao_complementar27" id="informacao_complementar27" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC27;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc27'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar27" id="informacao_complementar27" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC27;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc28'] == 1){ ?>
                                <input type="text" name="informacao_complementar28" id="informacao_complementar28" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC28;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc28'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar28" id="informacao_complementar28" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC28;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc29'] == 1){ ?>
                                <input type="text" name="informacao_complementar29" id="informacao_complementar29" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC29;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc29'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar29" id="informacao_complementar29" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC29;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc30'] == 1){ ?>
                                <input type="text" name="informacao_complementar30" id="informacao_complementar30" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC30;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc30'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar30" id="informacao_complementar30" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC30;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc31'] == 1){ ?>
                                <input type="text" name="informacao_complementar31" id="informacao_complementar31" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC31;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc31'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar31" id="informacao_complementar31" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC31;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc32'] == 1){ ?>
                                <input type="text" name="informacao_complementar32" id="informacao_complementar32" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC32;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc32'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar32" id="informacao_complementar32" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC32;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc33'] == 1){ ?>
                                <input type="text" name="informacao_complementar33" id="informacao_complementar33" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC33;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc33'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar33" id="informacao_complementar33" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC33;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc34'] == 1){ ?>
                                <input type="text" name="informacao_complementar34" id="informacao_complementar34" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC34;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc34'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar34" id="informacao_complementar34" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC34;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc35'] == 1){ ?>
                                <input type="text" name="informacao_complementar35" id="informacao_complementar35" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC35;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc35'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar35" id="informacao_complementar35" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC35;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc36'] == 1){ ?>
                                <input type="text" name="informacao_complementar36" id="informacao_complementar36" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC36;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc36'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar36" id="informacao_complementar36" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC36;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc37'] == 1){ ?>
                                <input type="text" name="informacao_complementar37" id="informacao_complementar37" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC37;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc37'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar37" id="informacao_complementar37" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC37;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc38'] == 1){ ?>
                                <input type="text" name="informacao_complementar38" id="informacao_complementar38" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC38;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc38'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar38" id="informacao_complementar38" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC38;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc39'] == 1){ ?>
                                <input type="text" name="informacao_complementar39" id="informacao_complementar39" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC39;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc39'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar39" id="informacao_complementar39" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC39;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc40'] == 1){ ?>
                                <input type="text" name="informacao_complementar40" id="informacao_complementar40" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC40;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc40'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar40" id="informacao_complementar40" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC40;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc41'] == 1){ ?>
                                <input type="text" name="informacao_complementar41" id="informacao_complementar41" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC41;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc41'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar41" id="informacao_complementar41" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC41;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc42'] == 1){ ?>
                                <input type="text" name="informacao_complementar42" id="informacao_complementar42" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC42;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc42'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar42" id="informacao_complementar42" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC42;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc43'] == 1){ ?>
                                <input type="text" name="informacao_complementar43" id="informacao_complementar43" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC43;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc43'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar43" id="informacao_complementar43" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC43;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc44'] == 1){ ?>
                                <input type="text" name="informacao_complementar44" id="informacao_complementar44" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC44;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc44'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar44" id="informacao_complementar44" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC44;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc45'] == 1){ ?>
                                <input type="text" name="informacao_complementar45" id="informacao_complementar45" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC45;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc45'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar45" id="informacao_complementar45" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC45;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc46'] == 1){ ?>
                                <input type="text" name="informacao_complementar46" id="informacao_complementar46" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC46;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc46'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar46" id="informacao_complementar46" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC46;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc47'] == 1){ ?>
                                <input type="text" name="informacao_complementar47" id="informacao_complementar47" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC47;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc47'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar47" id="informacao_complementar47" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC47;?></textarea>
                                <?php } ?>
                                ...
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 11){ ?>
                                    ...
                                    <textarea name="informacao_complementar47" id="informacao_complementar47"><?php echo $tbHistoricoIC47;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc48'] == 1){ ?>
                                <input type="text" name="informacao_complementar48" id="informacao_complementar48" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC48;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc48'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar48" id="informacao_complementar48" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC48;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc49'] == 1){ ?>
                                <input type="text" name="informacao_complementar49" id="informacao_complementar49" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC49;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc49'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar49" id="informacao_complementar49" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC49;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc50'] == 1){ ?>
                                <input type="text" name="informacao_complementar50" id="informacao_complementar50" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC50;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc50'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar50" id="informacao_complementar50" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC50;?></textarea>
                                <?php } ?>
                                ...
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 11){ ?>
                                    ...
                                    <textarea name="informacao_complementar50" id="informacao_complementar50"><?php echo $tbHistoricoIC50;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc51'] == 1){ ?>
                                <input type="text" name="informacao_complementar51" id="informacao_complementar51" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC51;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc51'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar51" id="informacao_complementar51" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC51;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc52'] == 1){ ?>
                                <input type="text" name="informacao_complementar52" id="informacao_complementar52" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC52;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc52'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar52" id="informacao_complementar52" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC52;?></textarea>
                                <?php } ?>
                                ...
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 11){ ?>
                                    ...
                                    <textarea name="informacao_complementar52" id="informacao_complementar52"><?php echo $tbHistoricoIC52;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc53'] == 1){ ?>
                                <input type="text" name="informacao_complementar53" id="informacao_complementar53" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC53;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc53'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar53" id="informacao_complementar53" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC53;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc54'] == 1){ ?>
                                <input type="text" name="informacao_complementar54" id="informacao_complementar54" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC54;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc54'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar54" id="informacao_complementar54" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC54;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc55'] == 1){ ?>
                                <input type="text" name="informacao_complementar55" id="informacao_complementar55" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC55;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc55'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar55" id="informacao_complementar55" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC55;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc56'] == 1){ ?>
                                <input type="text" name="informacao_complementar56" id="informacao_complementar56" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC56;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc56'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar56" id="informacao_complementar56" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC56;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc57'] == 1){ ?>
                                <input type="text" name="informacao_complementar57" id="informacao_complementar57" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC57;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc57'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar57" id="informacao_complementar57" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC57;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc58'] == 1){ ?>
                                <input type="text" name="informacao_complementar58" id="informacao_complementar58" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC58;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc58'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar58" id="informacao_complementar58" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC58;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc59'] == 1){ ?>
                                <input type="text" name="informacao_complementar59" id="informacao_complementar59" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC59;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc59'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar59" id="informacao_complementar59" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC59;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro TabelaCampos01Celula" colspan="3">
                        <div>
                            <?php if($GLOBALS['configHistoricoBoxIc60'] == 1){ ?>
                                <input type="text" name="informacao_complementar60" id="informacao_complementar60" class="CampoTexto01" maxlength="255" value="<?php echo $tbHistoricoIC60;?>" />
                            <?php } ?>
                            <?php if($GLOBALS['configHistoricoBoxIc60'] == 2){ ?>
                                <?php //Sem formatação.?>
                                <?php if($GLOBALS['configConteudoCaixaTexto'] == 1){ ?>
                                    <textarea name="informacao_complementar60" id="informacao_complementar60" class="CampoTextoMultilinha01"><?php echo $tbHistoricoIC60;?></textarea>
                                <?php } ?>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <select name="id_tb_cadastro_usuario" id="id_tb_cadastro_usuario" class="CampoDropDownMenu01">
                                <option value="0" selected="selected"<?php if($tbHistoricoIdTbCadastroUsuario == 0){ ?>selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemNenhumDropDown"); ?></option>
                                <?php 
                                for($countArray = 0; $countArray < count($arrHistoricoCadastroUsuario); $countArray++)
                                {
                                ?>
                                    <option value="<?php echo $arrHistoricoCadastroUsuario[$countArray][0];?>"<?php if($arrHistoricoCadastroUsuario[$countArray][0] == $tbHistoricoIdTbCadastroUsuario){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoCadastroUsuario[$countArray][1];?></option>
                                <?php 
                                }
                                ?>
                            </select>
                    ...
                    <td class="TbFundoClaro" colspan="3">
                        <div class="Texto01">
                            ...
                            <select name="id_tb_historico_status" id="id_tb_historico_status" class="CampoDropDownMenu01">
                                <option value="0"<?php if($tbHistoricoIdTbHistoricoStatus == 0){ ?>selected="selected"<?php } ?>><?php echo XMLFuncoes::XMLIdiomas($GLOBALS['xmlIdiomaSistema'], "sistemaItemFiltroGenerico03"); ?></option>
                                <?php 
                                for($countArray = 0; $countArray < count($arrHistoricoStatus); $countArray++)
                                {
                                ?>
                                    <option value="<?php echo $arrHistoricoStatus[$countArray][0];?>"<?php if($arrHistoricoStatus[$countArray][0] == $tbHistoricoIdTbHistoricoStatus){ ?> selected="selected"<?php } ?>><?php echo $arrHistoricoStatus[$countArray][1];?></option>
                                <?php 
                                }
                                ?>
                            </select>
