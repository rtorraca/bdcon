...
//----------
$strSqlOrcamentosItensUpdate = "";
$strSqlOrcamentosItensUpdate .= "UPDATE ce_orcamentos_itens ";
$strSqlOrcamentosItensUpdate .= "SET ";
//$strSqlOrcamentosItensUpdate .= "id = :id, ";
$strSqlOrcamentosItensUpdate .= "id_ce_orcamentos = :id_ce_orcamentos, ";
$strSqlOrcamentosItensUpdate .= "n_classificacao = :n_classificacao, ";
$strSqlOrcamentosItensUpdate .= "item_titulo = :item_titulo, ";
$strSqlOrcamentosItensUpdate .= "item_descricao = :item_descricao, ";
$strSqlOrcamentosItensUpdate .= "data1 = :data1, ";
$strSqlOrcamentosItensUpdate .= "data2 = :data2, ";
$strSqlOrcamentosItensUpdate .= "data3 = :data3, ";
$strSqlOrcamentosItensUpdate .= "data4 = :data4, ";
$strSqlOrcamentosItensUpdate .= "data5 = :data5, ";
$strSqlOrcamentosItensUpdate .= "url1 = :url1, ";
$strSqlOrcamentosItensUpdate .= "url2 = :url2, ";
$strSqlOrcamentosItensUpdate .= "url3 = :url3, ";
$strSqlOrcamentosItensUpdate .= "id_tb_cadastro1 = :id_tb_cadastro1, ";
$strSqlOrcamentosItensUpdate .= "id_tb_cadastro2 = :id_tb_cadastro2, ";
$strSqlOrcamentosItensUpdate .= "id_tb_cadastro3 = :id_tb_cadastro3, ";
$strSqlOrcamentosItensUpdate .= "valor = :valor, ";
$strSqlOrcamentosItensUpdate .= "valor1 = :valor1, ";
$strSqlOrcamentosItensUpdate .= "valor2 = :valor2, ";
$strSqlOrcamentosItensUpdate .= "ativacao = :ativacao, ";
$strSqlOrcamentosItensUpdate .= "ativacao1 = :ativacao1, ";
$strSqlOrcamentosItensUpdate .= "ativacao2 = :ativacao2, ";
$strSqlOrcamentosItensUpdate .= "ativacao3 = :ativacao3, ";
$strSqlOrcamentosItensUpdate .= "ativacao4 = :ativacao4, ";
$strSqlOrcamentosItensUpdate .= "informacao_complementar1 = :informacao_complementar1, ";
$strSqlOrcamentosItensUpdate .= "informacao_complementar2 = :informacao_complementar2, ";
$strSqlOrcamentosItensUpdate .= "informacao_complementar3 = :informacao_complementar3, ";
$strSqlOrcamentosItensUpdate .= "informacao_complementar4 = :informacao_complementar4, ";
$strSqlOrcamentosItensUpdate .= "informacao_complementar5 = :informacao_complementar5, ";
$strSqlOrcamentosItensUpdate .= "informacao_complementar6 = :informacao_complementar6, ";
$strSqlOrcamentosItensUpdate .= "informacao_complementar7 = :informacao_complementar7, ";
$strSqlOrcamentosItensUpdate .= "informacao_complementar8 = :informacao_complementar8, ";
$strSqlOrcamentosItensUpdate .= "informacao_complementar9 = :informacao_complementar9, ";
$strSqlOrcamentosItensUpdate .= "informacao_complementar10 = :informacao_complementar10 ";
$strSqlOrcamentosItensUpdate .= "WHERE id = :id ";
//echo "strSqlOrcamentosItensUpdate = " . $strSqlOrcamentosItensUpdate . "<br />";
//----------


$statementOrcamentosItensUpdate = $dbSistemaConPDO->prepare($strSqlOrcamentosItensUpdate);
...
"arquivo" => $arquivo
*/
if ($statementOrcamentosItensUpdate !== false)
{
	$statementOrcamentosItensUpdate->execute(array(
		"id" => $id,
...
//Limpeza de objetos.
//----------
unset($strSqlOrcamentosItensUpdate);
unset($statementOrcamentosItensUpdate);
//----------
